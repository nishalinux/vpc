		  ...
		  <div class="btn-group alignTop margin0px">
			<span class="pull-right">
			  <span class="btn-group">
				<button type="button"  id="listViewPreviousPageButton" {if $MODULEWIDGETS['pagination']['prevPageExists']}{else} disabled="disabled"{/if}class="btn">
				...
				<button type="button" {if $MODULEWIDGETS['pagination']['nextPageExists']}{else} disabled="disabled"{/if} id="listViewNextPageButton" class="btn">
