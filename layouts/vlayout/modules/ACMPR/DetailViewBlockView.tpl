...
{strip}
	...
	{*manasa added oct 28 2017 grid purpose*}
	{if $BLOCK_LABEL_KEY eq 'Section 5.a.i. Quantity to be Produced'}
		{include file="LineItemsDetail.tpl"|@vtemplate_path:'ACMPR'}
	{/if}
	{if $BLOCK_LABEL_KEY eq 'Section 4 Security Clearance'}
		{include file="ARPICDetail.tpl"|@vtemplate_path:'ACMPR'}
		<br/>
	{/if}
	{if $BLOCK_LABEL_KEY eq 'Section 4 Security Clearance'}
		{include file="PersonDetail.tpl"|@vtemplate_path:'ACMPR'}
	{/if}
