                                    ...
                                    <table style="width: 100%">
                                        <tr>
                                            ...
                                            {if $VTEMODULE->userguide_link!=''}
                                                <a href="index.php?module=VTEStore&parent=Settings&view=Settings&mode=getModuleDetail&extensionId={$VTEMODULE->id}&extensionName={$VTEMODULE->module_name}&tab=Documentation" target="_blank" title="{vtranslate('Documentation', 'VTEStore')}"><img src="layouts/vlayout/modules/VTEStore/resources/images/user_manual_filled1600.png" style="width: 25px; height: 25px;"/></a>
                                            {/if}
                                            {if $VTEMODULE->setting_url!='' && in_array($VTEMODULE->module_name,$VTMODULES)}
                                                <a href="{$VTEMODULE->setting_url}" target="_blank" title="{vtranslate('Settings', 'VTEStore')}"><img src="layouts/vlayout/modules/VTEStore/resources/images/setting.png" style="width: 25px; height: 25px;"/></a>
                                            {/if}
                                            </td>
                                        </tr>
                                    </table>
