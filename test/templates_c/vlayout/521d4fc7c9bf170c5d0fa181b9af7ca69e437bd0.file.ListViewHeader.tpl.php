<?php /* Smarty version Smarty-3.1.7, created on 2018-08-20 05:49:49
         compiled from "/var/www/html/BMLGDEMO65/includes/runtime/../../layouts/vlayout/modules/PointSale/ListViewHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4616761345b7a567dd4df79-59899585%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '521d4fc7c9bf170c5d0fa181b9af7ca69e437bd0' => 
    array (
      0 => '/var/www/html/BMLGDEMO65/includes/runtime/../../layouts/vlayout/modules/PointSale/ListViewHeader.tpl',
      1 => 1534744125,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4616761345b7a567dd4df79-59899585',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b7a567de4119',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b7a567de4119')) {function content_5b7a567de4119($_smarty_tpl) {?>
...
"><a href="#" <?php if (stripos($_smarty_tpl->tpl_vars['LISTVIEW_MASSACTION']->value->getUrl(),'javascript:')===0){?>onclick='<?php echo substr($_smarty_tpl->tpl_vars['LISTVIEW_MASSACTION']->value->getUrl(),strlen("javascript:"));?>
...
"><a <?php if (stripos($_smarty_tpl->tpl_vars['LISTVIEW_ADVANCEDACTIONS']->value->getUrl(),'javascript:')===0){?> href="#" onclick='<?php echo substr($_smarty_tpl->tpl_vars['LISTVIEW_ADVANCEDACTIONS']->value->getUrl(),strlen("javascript:"));?>
...
</strong></button></span><?php } ?>--><span class="btn-group"><button id="AddPos" class="btn addButton" onclick='window.location.href="index.php?module=PointSale&view=DashBoard"'><i class="icon-plus"></i>&nbsp;<strong>Create POS</strong></button></span></span><span class="btn-toolbar span4"><span class="customFilterMainSpan btn-group"><?php if (count($_smarty_tpl->tpl_vars['CUSTOM_VIEWS']->value)>0){?><select id="customFilter" style="width:350px;"><?php  $_smarty_tpl->tpl_vars['GROUP_CUSTOM_VIEWS'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['GROUP_CUSTOM_VIEWS']->_loop = false;
