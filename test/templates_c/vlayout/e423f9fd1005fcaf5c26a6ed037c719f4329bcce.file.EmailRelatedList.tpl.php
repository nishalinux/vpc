<?php /* Smarty version Smarty-3.1.7, created on 2018-08-17 21:35:25
         compiled from "/var/www/html/BMLGDEMO65/includes/runtime/../../layouts/vlayout/modules/Vtiger/EmailRelatedList.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13662523435b773f9db0f230-61790983%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e423f9fd1005fcaf5c26a6ed037c719f4329bcce' => 
    array (
      0 => '/var/www/html/BMLGDEMO65/includes/runtime/../../layouts/vlayout/modules/Vtiger/EmailRelatedList.tpl',
      1 => 1476789008,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13662523435b773f9db0f230-61790983',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b773f9dc428c',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b773f9dc428c')) {function content_5b773f9dc428c($_smarty_tpl) {?>
...
<?php }elseif($_smarty_tpl->tpl_vars['RELATED_HEADERNAME']->value=='filename'){?><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['RELATED_RECORD']->value->getId();?>
<?php $_tmp2=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["EMAILATTACHMENTS"] = new Smarty_variable($_smarty_tpl->tpl_vars['RELATED_RECORD']->value->getEmailRelatedAttachmentDetails($_tmp2), null, 0);?><?php  $_smarty_tpl->tpl_vars['ATTACHMENTDETAILS'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['ATTACHMENTDETAILS']->_loop = false;
 $_smarty_tpl->tpl_vars['k'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['EMAILATTACHMENTS']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['ATTACHMENTDETAILS']->key => $_smarty_tpl->tpl_vars['ATTACHMENTDETAILS']->value){
$_smarty_tpl->tpl_vars['ATTACHMENTDETAILS']->_loop = true;
 $_smarty_tpl->tpl_vars['k']->value = $_smarty_tpl->tpl_vars['ATTACHMENTDETAILS']->key;
?><a href="<?php echo $_smarty_tpl->tpl_vars['ATTACHMENTDETAILS']->value['path'];?>
/<?php echo $_smarty_tpl->tpl_vars['ATTACHMENTDETAILS']->value['fileid'];?>
_<?php echo $_smarty_tpl->tpl_vars['ATTACHMENTDETAILS']->value['attachment'];?>
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['ATTACHMENTDETAILS']->value['attachment'];?>
</a><br/><?php } ?><?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['RELATED_RECORD']->value->getDisplayValue($_smarty_tpl->tpl_vars['RELATED_HEADERNAME']->value);?>
