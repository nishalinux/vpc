...
class Vtiger_Widget_Model extends Vtiger_Base_Model {
	...
	public function getWidth() {
		...
		$title = $this->getName();
		/*---------Anjaneya Dashboard col 9---------- */		
		$largerSizedWidgets = array('GroupedBySalesPerson', 'PipelinedAmountPerSalesPerson', 'GroupedBySalesStage', 'Funnel Amount','LeadsByIndustry','ProjectsTaskProgress','ProjectsProgress');	
