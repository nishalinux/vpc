		...
		<div class="modal-body">
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<input type="text" name="label_modulename" class="span3 validate[required] text-input" />
				</div>
			</div>
			<div class="control-group">
				<span class="control-label">
				...
				<div class="controls">
					<span class="row-fluid">Choose an option<br>
						...
						<input class="span1" name="returnaction" id="returnaction" type="radio" title="Check to proceed to vtDZine new module after creation" value="vtdziner" checked="checked"/>&nbsp;vtDZine New Module<br>
						...
						<input class="span1" name="returnaction" id="returnaction" type="radio" title="Check to proceed to Home after creation" value="showhome"/>&nbsp;Vtiger Home<br>
					</span>
				</div>
			</div>
			<!--
