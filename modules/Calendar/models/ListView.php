	...
	public function getAdvancedLinks(){
		...
		if($importPermission && $createPermission) {
			$advancedLinks[] = array(
							...
							'linkurl' => 'javascript:Calendar_List_Js.triggerImportEventAction("index.php?module=Calendar&view=ImportEvent")',
							'linkicon' => ''
			);
		}
		/*--ADDED BY YOGITA: 10Nov17 :end*/
		...
		if($exportPermission) {
			$advancedLinks[] = array(
					...
					'linkurl' => 'javascript:Vtiger_List_Js.triggerExportAction("index.php?module=Events&view=Export")',
					'linkicon' => ''
				);
		}
		/*--ADDED BY YOGITA: 10Nov17:end*/
