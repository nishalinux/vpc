...
class Vtiger_ListView_Model extends Vtiger_Base_Model {
	...
	public function getListViewMassActions($linkParams) {
		...
		if($currentUserModel->hasModuleActionPermission($moduleModel->getId(), 'EditView')) {
			$massActionLinks[] = array(
				'linktype' => 'LISTVIEWMASSACTION',
				'linklabel' => 'LBL_BARCODE_GENERATION',
				'linkurl' => 'javascript:Vtiger_List_Js.massBarcodeGenerationRecords("index.php?module='.$moduleModel->get('name').'&action=MassBarcodeGeneration");',
				'linkicon' => ''
			);
		}
