...
function getInventoryTaxType($module, $id)
{
	...
	//added manasa pickingslip related details nov 15th 2017
	$inv_table_array = Array('PurchaseOrder'=>'vtiger_purchaseorder','SalesOrder'=>'vtiger_salesorder','Quotes'=>'vtiger_quotes','Invoice'=>'vtiger_invoice','PickingSlip' => 'vtiger_pickingslip','ProjectStock' => 'vtiger_projectstock');
	$inv_id_array = Array('PurchaseOrder'=>'purchaseorderid','SalesOrder'=>'salesorderid','Quotes'=>'quoteid','Invoice'=>'invoiceid','PickingSlip' => 'pickingslipid', 'ProjectStock' => 'projectstockid');
