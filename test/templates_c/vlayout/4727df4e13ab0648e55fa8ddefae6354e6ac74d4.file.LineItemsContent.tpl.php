<?php /* Smarty version Smarty-3.1.7, created on 2018-08-14 18:41:42
         compiled from "/var/www/html/BMLGDEMO65/includes/runtime/../../layouts/vlayout/modules/Inventory/LineItemsContent.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10645177425b732266913594-97502829%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4727df4e13ab0648e55fa8ddefae6354e6ac74d4' => 
    array (
      0 => '/var/www/html/BMLGDEMO65/includes/runtime/../../layouts/vlayout/modules/Inventory/LineItemsContent.tpl',
      1 => 1511182904,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10645177425b732266913594-97502829',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b732266ae087',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b732266ae087')) {function content_5b732266ae087($_smarty_tpl) {?>
...
" type="text" class="qty smallInputBox" <?php if ($_smarty_tpl->tpl_vars['MODULE']->value!='PickingSlip'){?>data-validation-engine="validate[required,funcCall[Vtiger_GreaterThanZero_Validator_Js.invokeValidation]]"<?php }else{ ?> data-validation-engine="validate[required,funcCall[Vtiger_GreaterThanPickingSlipQty_Validator_Js.invokeValidation]]"<?php }?> value="<?php if (!empty($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qty']->value])){?><?php echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qty']->value];?>
<?php }else{ ?>1<?php }?>"/><?php if ($_smarty_tpl->tpl_vars['MODULE']->value!='PurchaseOrder'){?><br><span class="stockAlert redColor <?php if ($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qty']->value]<=$_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qtyInStock']->value]){?>hide<?php }?>" ><?php if ($_smarty_tpl->tpl_vars['MODULE']->value!='PickingSlip'){?><?php echo vtranslate('LBL_STOCK_NOT_ENOUGH',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</span><?php }else{ ?><span class="maxQuantity"></span><?php }?></span><?php }?></td><td><div><input id="<?php echo $_smarty_tpl->tpl_vars['listPrice']->value;?>
