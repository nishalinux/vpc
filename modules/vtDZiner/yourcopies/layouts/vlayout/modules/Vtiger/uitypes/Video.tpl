...
.upload-wrapper {
    background: url(modules/vtDZiner/video.png) no-repeat;
...
<div class="upload-container">
  <span class="upload-wrapper">
    <input accept="video/*" class="movie-upload" id="{$MODULE}_editView_fieldName_{$FIELD_NAME}" type="file" name="{$FIELD_MODEL->getFieldName()}" />
  </span>
</div>
