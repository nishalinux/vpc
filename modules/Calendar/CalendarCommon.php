...
function getActivityDetails($description,$user_id,$from='')
{
	...
	{
		$end_date_lable='End date and time';
	}
	else
	{
		$end_date_lable='Due Date';
	}
	...
	$list .= '<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Start date and time : '.$startDate->getDisplayDateTimeValue($inviteeUser) .' '.getTranslatedString($inviteeUser->time_zone, 'Users');
	...
	$list .= '<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Priority: '.getTranslatedString($description['taskpriority']);
	$list .= '<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Related To: '.getTranslatedString($description['relatedto']);
