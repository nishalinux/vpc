...
{strip}
	...
	<table class="table table-bordered equalSplit detailview-table">
		...
		{if $BLOCK_LABEL_KEY == 'Users'}  
					<tr>
			{assign var="USERS_LIST_INFO" value=$USER_MODEL->getAccessibleUsersForModule($MODULE_NAME)}
			{assign var="GROUPS_LIST_INFO" value=$USER_MODEL->getAccessibleGroupForModule($MODULE_NAME)}		
						...
						<td colspan='4'> 
							<table class="table table-bordered equalSplit detailview-table">
								...
								{foreach key=info item=pt_taskdata from=$PT_USER_INFO}
									{assign var=row_no value=$pt_taskdata['userid']}
								<tr>
									{include file="Project_User_Task_Detail.tpl"|@vtemplate_path:'ProjectTask' row_no=$row_no data=$pt_taskdata}
