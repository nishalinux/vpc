   ...
   <head>
	  ...
	  <script src="libraries/jquery/boxslider/respond.min.js"></script>
	   ...
	   <script>
		jQuery(document).ready(function () {
			  ...
			  slider = jQuery('.bxslider').bxSlider({
		...
		</script></head><body><div class="vte-login-container"><div class="logo"><img src="loginimages/TheraCann_SYSTEM Logo_1517844048_1533730609.png" /></div><div class="row-fluid"><div class="span6 slideshow" style="margin-left:0;">
						<div class="carousal-container">
							<ul class="bxslider"><li> <div id="slide0" class="slide"><img class="pull-left" src="loginimages/IMPLEMENT_1517839005_1533730609.jpg"></div></li><li> <div id="slide1" class="slide"><img class="pull-left" src="loginimages/PLAN_1517839005_1533730609.jpg"></div></li></ul>
				</div>
				...
				<h1 class="login-header">firefox browser12</h1>
				<p class="subtitle">firefox browser14</p>
				</div>
