...
class Reports_Record_Model extends Vtiger_Record_Model {
	...
	function getReportRelatedModules() {
		$report = $this->report;
		//Ganesh added this on april 13th 2018 :: Reports Products module fields
		$report->related_modules['Invoice'][] = 'Products';
		//Ganesh added this on april 13th 2018 :: Reports Products module fields ended here
	...
	function getReportCSV() {
		...
		$rootDirectory = vglobal('root_directory');
		$tmpDir = vglobal('tmp_dir');
		//Ganesh added this on april 13th 2018::Csv file download
        $currentDT = date("Ymd");
		$BankCustID = '9999999';
		if($this->getId() == 40){
		$RType='KSL';
		}
		elseif($this->getId() == 41){
		$RType='MIT';
		}
		elseif($this->getId() == 42){
		$RType='PBV';
		}
        $CFilename = $BankCustID.'_'.$RType.'_'.$currentDT;
		...
		//Ganesh added this on april 13th 2018::Csv file download(Up line comment)
		$fileName = decode_html($CFilename).'.csv';
