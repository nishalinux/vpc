            ...
            <div class="row-fluid">
                <div class="btn-toolbar span10">
                    ...
                    <div class="btn-group">
                        ...
                        <input type="hidden" class="login_user" value="{$TEST123}">
                    </div>
                    <div class="btn-group">
        ...
        <div class="span12 details">
            ...
            {if $ATTACHMENTS}
                ...
                <span>
					...
					{assign var="AttachORGNAME" value=$FOLDER->getAttachnoid($MAIL->muid(),$ATTACHNAME)}{*manasa modified here*}
