            ...
            <table class="table table-bordered table-condensed listViewEntriesTable">
                <thead>
                    <tr class="listViewHeaders">
                        ...
                        <th width="20%" class="medium">{vtranslate('LBL_NAME',$QUALIFIED_MODULE)}</th>
                        <th width="15%" class="medium">{vtranslate('LBL_STATUS',$QUALIFIED_MODULE)}</th>                        
                        <th width="15%" class="medium">{vtranslate('LBL_FIELDS',$QUALIFIED_MODULE)}</th>
                        <th width="30%" class="medium">{vtranslate('LBL_FORMULA',$QUALIFIED_MODULE)}</th>
                        <th width="5%" class="medium">
                                <span class="btn-group actions">
                                    <a class="editBlockDetails" href='javascript: void(0);' data-url="index.php?module=FieldFormula&view=EditAjax&mode=getEditForm&record={$RECORDID}">
                ...
                <tbody>                    
                        <tr class="listViewEntries">
                            ...
                            <td width="15%" style="vertical-align:top !important;" nowrap class="medium">{if $LISTVIEW_ENTRY['status'] eq '1'}{vtranslate('LBL_ACTIVE',$QUALIFIED_MODULE)}{else}{vtranslate('LBL_INACTIVE',$QUALIFIED_MODULE)}{/if}</td>
                            
                            <td width="15%" style="vertical-align:top !important;" nowrap class="medium">
                                {vtranslate($LISTVIEW_ENTRY['field'], $LISTVIEW_ENTRY['field'])}
                            </td>
                            <td width="40%" style="vertical-align:top !important;" nowrap class="medium" colspan="2">
                                {vtranslate($LISTVIEW_ENTRY['formula'], $LISTVIEW_ENTRY['formula'])}
                            </td>
