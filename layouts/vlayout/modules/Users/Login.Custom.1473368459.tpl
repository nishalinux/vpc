...
{strip}
    ...
    <div class="vte-login-container">
        <div class="logo">
            <img src="test/logo/BMLG Logo Transparent v1.png" />
        </div>
        <div class="row-fluid">
                    ...
                    <ul class="bxslider">
                        <li>
                                <div id="slide0" class="slide">
                                    <img class="pull-left" src="test/logo/Plan 665 667 v1.jpg">
                                </div>
                            </li><li>
                                <div id="slide1" class="slide">
                                    <img class="pull-left" src="test/logo/Design 665 667 v1.jpg">
                                </div>
                            </li><li>
                                <div id="slide2" class="slide">
                                    <img class="pull-left" src="test/logo/Build 665 667 v1.jpg">
                                </div>
                            </li><li>
                                <div id="slide3" class="slide">
                                    <img class="pull-left" src="test/logo/Support 665 667 v1.jpg">
                                </div>
                            </li>
                    </ul>
                </div>
                ...
                <div class="span12 login-more-info vte-user-login">
                    <div class="row">
                        ...
                        <div class="span6 copy-right">
                            <small>Benchmark Labs 2016 www.benchmarklabs.com</small>
                        </div>
                    </div>
                </div>
