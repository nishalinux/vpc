...
var Vtiger_Index_Js = {
	...
	//added for help functionality
	 Homestuff : function(params){
	jQuery("#menubar_item_right_LBL_FEEDBACK").click(function(){
		
  var aDeferred = jQuery.Deferred();
		var url = "index.php?module="+app.getModuleName()+"&action=Homestuff";
		console.log(url);
    ...
    Faqdetail : function(params){
	jQuery("#menubar_item_right_LBL_FEEDBACK").click(function(){
		
  var aDeferred = jQuery.Deferred();
		var url = "index.php?module="+app.getModuleName()+"&action=Faqdetail";
		console.log(url);
	...
	registerEvents : function(){
		...
		Vtiger_Index_Js.Homestuff();
		Vtiger_Index_Js.Faqdetail();
