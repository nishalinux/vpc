...
class yetiforce extends rcube_plugin
{
	...
	public function addFilesToMail()
	{
		...
		foreach ($attachments as $attachment) {
			...
			//$htmlAttachments .= 'parent.rcmail.add2attachment_list("rcmfile'.$id.'",{html:"'.$content.'",name:"' . $attachment['name'] . '",mimetype:"' . $attachment['mimetype'] . '",classname:"' . rcube_utils::file2class($attachment['mimetype'], $attachment['name']) . '",complete:true},"' . $uploadid . '");' . PHP_EOL;
			...
			//parent.rcmail.add2attachment_list("rcmfile111529497872001038300",{"html":"\u003Ca href=\"#load\" class=\"filename\" onclick=\"return rcmail.command('load-attachment','rcmfile111529497872001038300', this, event)\"\u003Eimage001.png \u003Cspan class=\"attachment-size\"\u003E (1 KB)\u003C\/span\u003E\u003C\/a\u003E\u003Ca href=\"#delete\" onclick=\"return rcmail.command('remove-attachment','rcmfile111529497872001038300', this, event)\" title=\"Delete\" class=\"delete\" aria-label=\"Delete image001.png\"\u003E\u003C\/a\u003E","name":"image001.png","mimetype":"image\/png","classname":"image png","complete":true},"1529497868162");
			...
			//$htmlAttachments .= 'parent.rcmail.add2attachment_list("rcmfile' . $id . '",{"html":"\u003Ca href=\"#load\" class=\"filename\" onclick=\"return rcmail.command(\'load-attachment\',\'rcmfile'. $id .'\, this, event)\"\u003E' . $attachment['name'] . ' \u003Cspan class=\"attachment-size\"\u003E (63 KB)\u003C\/span\u003E\u003C\/a\u003E\u003Ca href=\"#delete\" onclick=\"return rcmail.command(\'remove-attachment\',\'rcmfile'. $id .'\, this, event)\" title=\"Delete\" class=\"delete\" aria-label=\"' . $this->rc->gettext('delete') . ' ' . $attachment['name'] . '\"\u003E\u003C\/a\u003E","name":"' . $attachment['name'] . '","mimetype":"' . $attachment['mimetype'] . '","classname":"' . rcube_utils::file2class($attachment['mimetype'], $attachment['name']) . '","complete":true},"' . $uploadid . '");' . PHP_EOL;

		//	parent.rcmail.add2attachment_list("rcmfile111529485696023100400",{"html":"\u003Ca href=\"#load\" class=\"filename\" onclick=\"return rcmail.command('load-attachment','rcmfile111529485696023100400', this, event)\"\u003E362293_Plug-Types.jpg \u003Cspan class=\"attachment-size\"\u003E (63 KB)\u003C\/span\u003E\u003C\/a\u003E\u003Ca href=\"#delete\" onclick=\"return rcmail.command('remove-attachment','rcmfile111529485696023100400', this, event)\" title=\"Delete\" class=\"delete\" aria-label=\"Delete 362293_Plug-Types.jpg\"\u003E\u003C\/a\u003E","name":"362293_Plug-Types.jpg","mimetype":"image\/jpeg","classname":"image jpeg jpg","complete":true},"1529485691146");*/
		}
...
<body>
	...
	public function getAttachment($ids, $files)
	{
		...
		if ($ids) {
			...
			$sql_result = $db->query("SELECT vtiger_attachments.* FROM vtiger_attachments INNER JOIN vtiger_seattachmentsrel ON vtiger_seattachmentsrel.attachmentsid=vtiger_attachments.attachmentsid WHERE vtiger_seattachmentsrel.attachmentsid IN ($ids);");
