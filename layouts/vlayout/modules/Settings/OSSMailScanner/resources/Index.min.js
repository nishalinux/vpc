...
jQuery.Class("Settings_OSSMailScanner_Index_Js", {}, {
	...
	registerEditFolders: function (container) {
		container.find('.editFolders').on('click', function () {
			...
			app.showModalWindow("", url, function (data) {
				console.log(data);
				$("#modalFolders").addClass("in");
				$(".modal-dialog").removeClass("modal-lg");
				progressIndicatorElement.progressIndicator({mode: 'hide'});
				$('#globalmodalse').html(data);
				data.find(".close").click(function(){
					$('#globalmodalse').html('');					
				});
				data.find('[type="reset"]').click(function () {
					$('#globalmodalse').html('');
				});
	...
	registerEvents: function () {
		...
		//jQuery("select[id='user_list_4']").change(function () {/
