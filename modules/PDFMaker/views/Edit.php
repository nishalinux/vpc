            ...
            if (count($block_fields) > 0) {
                ...
                while ($row1 = $adb->fetchByAssoc($result1)) {
                    ...
                    if ($fieldname == 'currency_id') {
                        ...
                        $User_Info[$optgroup_value][$option_key] = vtranslate('LBL_CURRENCY_ID', 'PDFMaker');
                        $User_Info[$optgroup_value]["USERS_CURRENCY_NAME"] = $option_value;
                        $User_Info[$optgroup_value]["USERS_CURRENCY_CODE"] = vtranslate('LBL_CURRENCY_CODE', 'PDFMaker');
                        $User_Info[$optgroup_value]["USERS_CURRENCY_SYMBOL"] = vtranslate('LBL_CURRENCY_SYMBOL', 'PDFMaker');
                        
                        $Logged_User_Info[$optgroup_value]["R_" . $option_key] = vtranslate('LBL_CURRENCY_ID', 'PDFMaker');
                        $Logged_User_Info[$optgroup_value]["R_USERS_CURRENCY_NAME"] = $option_value;
                        $Logged_User_Info[$optgroup_value]["R_USERS_CURRENCY_CODE"] = vtranslate('LBL_CURRENCY_CODE', 'PDFMaker');
                        $Logged_User_Info[$optgroup_value]["R_USERS_CURRENCY_SYMBOL"] = vtranslate('LBL_CURRENCY_SYMBOL', 'PDFMaker');
