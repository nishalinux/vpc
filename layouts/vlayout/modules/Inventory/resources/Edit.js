...
Vtiger_Edit_Js("Inventory_Edit_Js",{
	...
	Quotes_addressFieldsMapping : {'Contacts' :
								...
								'ship_code' : 'otherzip',
	         //Commented Madhav 'cf_1002' : 'mailingzip',
             //Commented Madhav 'cf_1004' : 'otherzip',
			 //Commented Madhav	'cf_1001' : 'cf_977',
			 //Commented Madhav	'cf_1003' : 'cf_979',
							...
							'Accounts' :
								...
								'bill_code' : 'bill_code',
								'ship_code' : 'ship_code',
			 //Commented Madhav	'cf_1002' : 'cf_999',
			 //Commented Madhav	'cf_1004' : 'cf_1000',
			 //Commented Madhav	'cf_1001' : 'cf_997',
			 //Commented Madhav	'cf_1003' : 'cf_998',
			...
			//Commented Madhav	'cf_1002' : 'cf_1006',
			//Commented Madhav	'cf_1004' : 'cf_1006',
			//Commented Madhav	'cf_1001' : 'cf_1005',
		  //Commented Madhav	'cf_1003' : 'cf_1005',
								'ship_country' : 'country'
								}
							},

	//Address field mapping between modules specific for billing and shipping
	Quotes_addressFieldsMappingBetweenModules:{
								'AccountsBillMap' : {
									'bill_street' :  'bill_street',
									'bill_pobox' : 'bill_pobox',
									'bill_city' : 'bill_city',
			...
			//Commented Madhav		'cf_1003' : 'cf_997',
									 //'cf_1004' : 'cf_999',
									//'cf_1004' : 'cf_1000',
									//'cf_1003' : 'cf_998',
									'ship_country' : 'ship_country'
								...
								'ContactsBillMap' : {
									...
									'bill_state' : 'mailingstate',
									'bill_code' : 'mailingzip',
				//Commented Madhav	'bill_code' : 'cf_978',
				//Commented Madhav	'cf_1001' : 'cf_977',
				//Commented Madhav	'cf_1002' : 'mailingzip',
									'bill_country' : 'mailingcountry'
									},
	...
	Quotes_addressFieldsMappingInModule : {
										'bill_street':'ship_street',
										'bill_pobox':'ship_pobox',
										'bill_city'	:'ship_city',
										'bill_state':'ship_state',
										'bill_code'	:'ship_code',
				//Commented Madhav		'cf_1002' : 'cf_1004',
				//Commented Madhav	    'cf_1001' : 'cf_1003',
								        'bill_country':'ship_country'
								},

	PO_addressFieldsMapping : {'Contacts' :
								{'bill_street' :  'mailingstreet',
								'ship_street' : 'otherstreet',
								'bill_pobox' : 'mailingpobox',
								'ship_pobox' : 'otherpobox',
								...
								'bill_code' : 'mailingzip',
								'ship_code' : 'otherzip',
			//Commented Madhav	'cf_1008' : 'mailingzip',
			//Commented Madhav	'cf_1010' : 'otherzip',
			//Commented Madhav	'cf_1007' : 'cf_977',
			//Commented Madhav	'cf_1009' : 'cf_979',
								'bill_country' : 'mailingcountry',
								'ship_country' : 'othercountry'
								} ,
							...
							'Accounts' :
								...
								'bill_code' : 'bill_code',
								'ship_code' : 'ship_code',
			//Commented Madhav	'cf_1008' : 'cf_999',
			//Commented Madhav	'cf_1010' : 'cf_1000',
			//Commented Madhav	'cf_1007' : 'cf_997',
			//Commented Madhav	'cf_1009' : 'cf_998',
								'bill_country' : 'bill_country',
								'ship_country' : 'ship_country'
								},
							...
							'Vendors' :
								...
								'ship_code' : 'postalcode',
								'bill_country' : 'country',
			//Commented Madhav	'cf_1008' : 'cf_1006',
			//Commented Madhav	'cf_1010' : 'cf_1006',
			//Commented Madhav	'cf_1007' : 'cf_1005',
			//Commented Madhav	'cf_1009' : 'cf_1005',
								'ship_country' : 'country'
								}
							},

	//Address field mapping between modules specific for billing and shipping
	PO_addressFieldsMappingBetweenModules:{
								'AccountsBillMap' : {
									'bill_street' :  'bill_street',
									'bill_pobox' : 'bill_pobox',
									'bill_city' : 'bill_city',
	...
	//Address field mapping within module
	PO_addressFieldsMappingInModule : {
										'bill_street':'ship_street',
										'bill_pobox':'ship_pobox',
										'bill_city'	:'ship_city',
										'bill_state':'ship_state',
										'bill_code'	:'ship_code',
					//Commented Madhav	'cf_1008' : 'cf_1010', //Modified by Madhav 04oct16
					//Commented Madhav	'cf_1007' : 'cf_1009',//Modified by Madhav 04oct16
								       // 'cf_1009' : 'cf_1005',//Added by Madhav 04oct16
								        //'cf_1010' : 'cf_1006',//Added by Madhav 04oct16
								        'bill_country':'ship_country'
								},

	Invoice_addressFieldsMapping : {'Contacts' :
								{'bill_street' :  'mailingstreet',
								'ship_street' : 'otherstreet',
								'bill_pobox' : 'mailingpobox',
								'ship_pobox' : 'otherpobox',
	...
	//Address field mapping between modules specific for billing and shipping
	Invoice_addressFieldsMappingBetweenModules:{
								'AccountsBillMap' : {
									'bill_street' :  'bill_street',
									'bill_pobox' : 'bill_pobox',
									'bill_city' : 'bill_city',
				...
				//Commented Madhav	'bill_code' : 'cf_978',
								...
								'ContactsShipMap' : {
									...
									'ship_city'  : 'othercity',
									'ship_state' : 'otherstate',
				//Commented Madhav	'ship_code' : 'cf_1028',
										//'cf_1003' : 'cf_979',
										//'cf_1004' : 'otherzip',
									'ship_country' : 'othercountry'
									}
	...
	//Address field mapping within module
	Invoice_addressFieldsMappingInModule : {
										'bill_street':'ship_street',
										'bill_pobox':'ship_pobox',
										'bill_city'	:'ship_city',
										'bill_state':'ship_state',
...
SO_addressFieldsMapping : {'Contacts' :
								{'bill_street' :  'mailingstreet',
								'ship_street' : 'otherstreet',
								'bill_pobox' : 'mailingpobox',
								'ship_pobox' : 'otherpobox',
	...
	//Address field mapping between modules specific for billing and shipping
	SO_addressFieldsMappingBetweenModules:{
								'AccountsBillMap' : {
									'bill_street' :  'bill_street',
									'bill_pobox' : 'bill_pobox',
									'bill_city' : 'bill_city',
	...
	//Address field mapping within module
	SO_addressFieldsMappingInModule : {
										'bill_street':'ship_street',
										'bill_pobox':'ship_pobox',
										'bill_city'	:'ship_city',
										'bill_state':'ship_state',
	...
	/**SO_addressFieldsMappingInModule SO_addressFieldsMappingBetweenModules SO_addressFieldsMapping
	...
	registerReferenceSelectionEvent : function(container) {
		...
		if(usermodule =='Quotes'){
		thisInstance.addressFieldsMappingInModule = jQuery.extend( {}, thisInstance.Quotes_addressFieldsMappingInModule);
		 thisInstance.addressFieldsMappingBetweenModules = jQuery.extend({}, thisInstance.Quotes_addressFieldsMappingBetweenModules);
		 thisInstance.addressFieldsMapping = jQuery.extend({}, thisInstance.Quotes_addressFieldsMapping);
		}
		else if(usermodule =='Invoice'){
		...
		else if(usermodule =='PurchaseOrder'){
		...
		else if(usermodule =='SalesOrder'){
		 thisInstance.addressFieldsMappingInModule = jQuery.extend( {}, thisInstance.SO_addressFieldsMappingInModule);
		 thisInstance.addressFieldsMappingBetweenModules = jQuery.extend( {}, thisInstance.SO_addressFieldsMappingBetweenModules);
		 thisInstance.addressFieldsMapping = jQuery.extend({}, thisInstance.SO_addressFieldsMapping);
	...
	mapAddressDetails : function(addressDetails, result, container) {
		for(var key in addressDetails) {
			...
			console.log('values');
			console.log(key);
			console.log(result[addressDetails[key]]);
		}
	},
	...
	//Added by Madhav for  vendor detail popuplated in adress block Start-------------------->
	/** Code Added to populate vendors address in purchase order address field-- START--**/
		
		referenceSelectionVendorEventHandler : function(data, container){
			var thisInstance = this;
		var message = app.vtranslate('OVERWRITE_EXISTING_MSG1')+app.vtranslate(data['source_module'])+' ('+data['selectedName']+') '+app.vtranslate('OVERWRITE_EXISTING_MSG2');
		Vtiger_Helper_Js.showConfirmationBox({'message' : message}).then(
		function(e) {
			if(data['source_module']=='Vendors'){
				console.log('data',data);
						console.log('container',container);
							thisInstance.copyVendorsDetails(data, container);
		...
		copyVendorsDetails : function(data,container,addressMap) {
		var thisInstance = this;
		var sourceModule = data['source_module'];
		var noAddress = true;
		var errorMsg;
		...
		thisInstance.getRecordDetails(data).then(
			...
			function(data){
			console.log('heree in copyVendorsDetails',data);
			var response = data['result'];
				//if(typeof addressMap != "undefined"){
					console.log('heree in response',response);

			var result = response['data'];
					console.log('heree in result',result);
		
				container.find('[name="bill_street"]').val(result['street']);
			    container.find('[name="bill_street"]').trigger('change');	

				container.find('[name="bill_pobox"]').val(result['pobox']);
			    container.find('[name="bill_pobox"]').trigger('change');	
					
				container.find('[name="bill_city"]').val(result['city']);
			    container.find('[name="bill_city"]').trigger('change');

				container.find('[name="cf_1007"]').val(result['cf_1005']);
			    container.find('[name="cf_1007"]').trigger('change');

				container.find('[name="bill_state"]').val(result['state']);
			    container.find('[name="bill_state"]').trigger('change');

				container.find('[name="bill_code"]').val(result['postalcode']);
			    container.find('[name="bill_code"]').trigger('change');

				container.find('[name="cf_1008"]').val(result['cf_1006']);
			    container.find('[name="cf_1008"]').trigger('change');

				container.find('[name="bill_country"]').val(result['country']);
			    container.find('[name="bill_country"]').trigger('change');
				
				/*container.find('[name="cf_1009"]').val(result['cf_1007']);
			    container.find('[name="cf_1009"]').trigger('change');
			    
			    container.find('[name="cf_1010"]').val(result['cf_1008']);
			    container.find('[name="cf_1010"]').trigger('change');*/
	...
	//Added by Madhav for  vendor detail popuplated in adress block End-------------------->
