...
class Project_DetailView_Model extends Vtiger_DetailView_Model {
	...
	//Project Product Quantity Purpose
	public function getDetailViewLinks($linkParams) {
		...
		if($currentUserModel->hasModulePermission($productsModuleModel->getId())) {
			$basicActionLink = array(
				'linktype' => 'DETAILVIEWRELATED',
				'linklabel' => 'Products Qty Info of Projects',
				'linkurl' => 'index.php?module=Project&relatedModule=Products&view=Detail&record='.$recordModel->getId().'&mode=showProductPODetails',
				'linkicon' => ''
			);
			$linkModelList['DETAILVIEWRELATED'][] = Vtiger_Link_Model::getInstanceFromValues($basicActionLink);
		}
