...
$languageStrings = array(
    ...
    'VTEStore' => 'Theracann Premium',
    'LBL_REQUIREMENTS' => 'Requirements',
    'LBL_LICENSING' => 'Licensing',
    'LBL_COMPLETE' => 'Complete',
    'LBL_WELCOME' => 'Welcome to the Theracann Premium',
    'LBL_INSTALLATION_WIZARD' => 'Installation Wizard',
    'LBL_INSTALL' => 'Install',
    'LBL_THANK' => 'Thank you for trying out the Theracann Premium Extension Package!',
    ...
    'LBL_YOU_WILL_NOT' => 'You will not be able to complete Theracann Premium',
    ...
    'LBL_THE_UPGRADE_WILL_NOT_IMPACT' => "The upgrade will not impact any of the extensions that have already been installed or any existing Theracann functionality.<br>It will simply upgrade the 'Extension Pack Engine' that we use to display, install & upgrade extensions.",
    /* For License page - End */

    'MODULE_LBL' => 'Theracann Premium',
    ...
    'LBL_INSTALL' => 'Install',
    'LBL_LOGIN_TO_VTE_STORE' => 'Login to Theracann Premium',
    'LBL_EMAIL' => 'Email',
    'LBL_PASSWORD' => 'Password',
    'LBL_CREATE_AN_ACCOUNT' => 'Create a new account',
    'LBL_LOGIN' => 'Login',
    'LBL_SIGN_UP_TO_VTE_STORE' => 'Sign up for Theracann Premium',
    ...
    'LBL_UPGRADE_VTE_STORE'=>'Upgrade Theracann Premium',
    'LBL_UPGRADE_VTE_STORE_TO_STABLE'=>'Upgrade Theracann Premium to Stable',
    'LBL_UPGRADE_VTE_STORE_TO_LASTEST'=>'Upgrade Theracann Premium to Lastest (Alpha)',
    ...
    'LBL_MESSAGE_UPGRAGE_VTE_STORE_TO_STABLE'=>'Are you sure you want to upgrade Theracann Premium module to Stable? ',
    'LBL_MESSAGE_UPGRAGE_VTE_STORE_TO_LASTEST'=>'Are you sure you want to upgrade Theracann Premium module?',
    'LBL_USABILITY'=>'Usability',
    'Subscription_Help'=>'Subscription Help',
    'Troubleshooting'=>'Troubleshooting',
    'VTEStore Update Required'=>'Theracann Premium Extension Update Required',
    'out of date'=>'Your Theracann Premium Extension is out of date. You must upgrade in order to proceed.',
    ...
    "MSG_CANNOT_SEND_EMAIL"=>"Cannot send email. Please check your outgoing server.",
    ...
    "TXT_CHANGE_URL_OUR_RECORD_INDICATE"=>"Our records indicate that this account is associated with another Theracann instance. This is usually caused when:",
    "TXT_CHANGE_URL_VTIGER_WAS_MOVED"=>"Theracann was moved to another server",
    ...
    "TXT_CHANGE_URL_IN_ORDER_TO_LOGIN"=>"In order to login and continue using Theracann plugins - we will move your account to this instance.",
    ...
    "TXT_CHANGE_URL_ONCE_THE_ACCOUNT_IS_MOVED"=>"<b>Once the account is moved, the extensions on the previous Theracann instance will be disabled automatically and you will no longer be able to use them.</b>",
