...
{strip}
    ...
    <div class="vte-login-container">
        <div class="logo">
            <img src="test/logo/Theracann-Logo-large.png" />
        </div>
        <div class="row-fluid">
                    ...
                    <ul class="bxslider">
                        <li>
                                <div id="slide0" class="slide">
                                    <img class="pull-left" src="test/logo/20160913-TheraCannVerticalBucket-SG-v03.jpg">
                                </div>
                            </li><li>
                                <div id="slide1" class="slide">
                                    <img class="pull-left" src="test/logo/20160902-TheraCannHeroes-act-wText.gif">
                                </div>
                            </li><li>
                                <div id="slide2" class="slide">
                                    <img class="pull-left" src="test/logo/20160902-TheraCannHeroes-build-wText.gif">
                                </div>
                            </li><li>
                                <div id="slide3" class="slide">
                                    <img class="pull-left" src="test/logo/20160902-TheraCannHeroes-grow-wText.gif">
                                </div>
                            </li><li>
                                <div id="slide4" class="slide">
                                    <img class="pull-left" src="test/logo/20160902-TheraCannHeroes-market-wText.gif">
                                </div>
                            </li><li>
                                <div id="slide5" class="slide">
                                    <img class="pull-left" src="test/logo/20160902-TheraCannHeroes-insight-wText.gif">
                                </div>
                            </li>
                    </ul>
                </div>
            ...
            <div class="span6 login-area">
                ...
                <div class="span12 site-info">
                    <h1 class="login-header">TheraCannSYSTEM</h1>
                    <p>One SYSTEM One SOLUTION</p>
                </div>
                ...
                <div class="span12 login-more-info vte-user-login">
                    <div class="row">
                        ...
                        <div class="span6 copy-right">
                            <small>TheraCann International Corporation 2016 www.thereacanncorp.com</small>
                        </div>
                    </div>
                </div>
