...
<div class='editViewContainer container-fluid'>
	<form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="index.php" enctype="multipart/form-data">
		...
		{/if}
		{*Manasa added this columns for pickingslip purpose*}
		{if $MODULE eq 'PickingSlip'}
		<input type="hidden" name="LOCKUNLOCKQTY" id="LOCKUNLOCKQTY" data-value='{Vtiger_Util_Helper::toSafeHTML(ZEND_JSON::encode($LOCKUNLOCKQTY))}' />
		<input type="hidden" name="PROJECTPRODUCTDETAILS" id="PROJECTPRODUCTDETAILS" data-value="{Vtiger_Util_Helper::toSafeHTML(ZEND_JSON::encode($PROJECTPRODUCTDETAILS))}"/>
		{/if}
		{*Manasa ended here*}
