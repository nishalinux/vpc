...
<html>
   ...
   <body>
      <div class="vte-login-container"><div class="logo"><img src="loginimages/Theracann-Logo-large_1533111115.png" /></div><div class="row-fluid"><div class="span6 slideshow">
						<div class="carousal-container">
							<ul class="bxslider"><li> <div id="slide0" class="slide"><img class="pull-left" src="loginimages/PLAN_1533111115.jpg"></div></li><li> <div id="slide1" class="slide"><img class="pull-left" src="loginimages/SUPPORT_1533111115.jpg"></div></li></ul>
				</div>
				...
				<form class="form-horizontal login-form" action="index.php?module=Users&action=Login" method="POST">
					...
					<div class="row">
						<div class="span6 username"><input type="text" id="username" autofocus name="username" placeholder="Username" value=""></div>
				...
				<div class="row"><div class="span4 social" >
						...
						<a class="social" target="_blank" href="facebook.com/"><i class="icon-social-facebook icons"></i></a>
								</div><div class="span6 copy-right" ><small>©TheraCann International Benchmark Corporation 2017. 
All rights reserved. www.theracanncorp.com</small></div></div>
				</div>
			</div></div>
      </div>
