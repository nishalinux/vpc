<?php /* Smarty version Smarty-3.1.7, created on 2018-08-14 17:53:01
         compiled from "/var/www/html/BMLGDEMO65/includes/runtime/../../layouts/vlayout/modules/Vtiger/RelatedList.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14862489155b7316fd8881b3-75937949%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '66c033b986e9df626a2bb35e4ed78f3dd10f12f1' => 
    array (
      0 => '/var/www/html/BMLGDEMO65/includes/runtime/../../layouts/vlayout/modules/Vtiger/RelatedList.tpl',
      1 => 1472033973,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14862489155b7316fd8881b3-75937949',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b7316fd9c8cf',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b7316fd9c8cf')) {function content_5b7316fd9c8cf($_smarty_tpl) {?>
...
<?php }elseif($_smarty_tpl->tpl_vars['HEADER_FIELD']->value->get('uitype')==545&&$_smarty_tpl->tpl_vars['RELATED_MODULE_NAME']->value=='Sample'){?><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['HEADER_FIELD']->value->getName();?>
<?php $_tmp2=ob_get_clean();?><?php  $_smarty_tpl->tpl_vars['IMAGE_INFO'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['IMAGE_INFO']->_loop = false;
 $_smarty_tpl->tpl_vars['ITER'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['RELATED_RECORD']->value->getGalleryDetails($_tmp2); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['IMAGE_INFO']->key => $_smarty_tpl->tpl_vars['IMAGE_INFO']->value){
$_smarty_tpl->tpl_vars['IMAGE_INFO']->_loop = true;
 $_smarty_tpl->tpl_vars['ITER']->value = $_smarty_tpl->tpl_vars['IMAGE_INFO']->key;
?><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['IMAGE_INFO']->value['orgname'];?>
<?php $_tmp3=ob_get_clean();?><?php if (!empty($_smarty_tpl->tpl_vars['IMAGE_INFO']->value['path'])&&!empty($_tmp3)){?><img src="<?php echo $_smarty_tpl->tpl_vars['IMAGE_INFO']->value['path'];?>
_<?php echo $_smarty_tpl->tpl_vars['IMAGE_INFO']->value['orgname'];?>
" width="150" height="80"><?php }?><?php } ?><?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['RELATED_RECORD']->value->getDisplayValue($_smarty_tpl->tpl_vars['RELATED_HEADERNAME']->value);?>
