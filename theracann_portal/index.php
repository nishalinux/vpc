	...
	if($_SESSION['customer_id'] != '')
	{
		...
		if($_REQUEST['downloadfile'] == 'true' && requestValidateReadAccess())
		{
			...
			if($_REQUEST['module'] == 'Invoice' || $_REQUEST['module'] == 'Quotes')
			{
				...
				$portaltype = $_SESSION['portaltype'];
				$params = array('id' => "$id", 'block'=>"$block", 'contactid'=>"$customerid",'sessionid'=>"$sessionid",'portaltype'=>$portaltype);
			...
			else if($_REQUEST['module'] == 'Documents')
			{
				...
				$block = $_REQUEST['module'];
				$portaltype = $_SESSION['portaltype'];
				$params = array('id' => "$id", 'folderid'=> "$folderid",'block'=>"$block", 'contactid'=>"$customerid",'sessionid'=>"$sessionid",'portaltype'=>$portaltype);
			...
			$customerid = $_SESSION['customer_id'];
			$sessionid = $_SESSION['customer_sessionid'];
			$portaltype = $_SESSION['portaltype'];//manasa	
		...
		if($_REQUEST['module'] != '' && $_REQUEST['action'] != '')
		{
			...
			if(isset($_SESSION['__permitted_modules'])) {
				...
				//$params = array($customerid);manasa
				$params =  Array(Array('customerid'=>$customerid,'portaltype'=>$portaltype));
