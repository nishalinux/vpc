...
<div class="listViewEntriesDiv contents-bottomscroll">
	...
	<table class="table table-bordered listViewEntriesTable">
		...
		<!---------- Anjaaneya ---------->
			{if $LISTVIEW_ENTRY->get('pcm_active')  == 0 }
				{assign var=TaskStatus value=1 }
			{else}
				{assign var=TaskStatus value=0 }
			{/if}
		<!----------End Anjaaneya ---------->
		
		<tr class="listViewEntries" data-id='{$LISTVIEW_ENTRY->getId()}' data-recordUrl='{$LISTVIEW_ENTRY->getDetailViewUrl()}' id="{$MODULE}_listView_row_{$smarty.foreach.listview.index+1}" style="{if $TaskStatus == 1 } background-color: #c2f0f0; {/if}" >
