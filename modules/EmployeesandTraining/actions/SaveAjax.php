...
class EmployeesandTraining_SaveAjax_Action extends Vtiger_SaveAjax_Action {
	...
	public function process(Vtiger_Request $request) {
		...
		foreach ($fieldModelList as $fieldName => $fieldModel) {
			...
			// Code added to transform custom ui types
			switch($fieldModel->getFieldDataType()){
				case 'meter' :
				$meterValue = $fieldValue/100;
				$result[$fieldName] = array('value' => $fieldValue, 'display_value' => '<meter value="'.$meterValue.'"></meter>&nbsp;&nbsp;['.$fieldValue.']');
				break;

				case 'youtube' :
				$result[$fieldName] = array('value' => $fieldValue, 'display_value' => 'Click here to change Video URL<iframe src="'.$fieldValue.'" frameborder="0" allowfullscreen></iframe>');
				break;
