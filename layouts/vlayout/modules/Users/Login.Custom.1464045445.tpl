...
{strip}
    ...
    <div class="vte-login-container">
        <div class="logo">
            <img src="test/logo/benchmark_orange.gif" />
        </div>
        <div class="row-fluid">
                    ...
                    <ul class="bxslider">
                        <li>
                                <div id="slide0" class="slide">
                                    <img class="pull-left" src="test/logo/img_10-665_667.jpg">
                                </div>
                            </li><li>
                                <div id="slide1" class="slide">
                                    <img class="pull-left" src="test/logo/img_21 665_667.jpg">
                                </div>
                            </li><li>
                                <div id="slide2" class="slide">
                                    <img class="pull-left" src="test/logo/img_13 665_667.jpg">
                                </div>
                            </li>
                    </ul>
                </div>
            ...
            <div class="span6 login-area">
                ...
                <div class="span12 site-info">
                    <h1 class="login-header">One SYSTEM One SOLUTION!</h1>
                    <p>Benchmark Labs SYSTEM is the first ISO 17025(2005) and Safe Quality Food (SQF) compliant Seed-to-Sale Software!</p>
                </div>
