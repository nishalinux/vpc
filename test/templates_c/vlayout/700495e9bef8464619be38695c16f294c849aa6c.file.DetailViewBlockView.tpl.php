<?php /* Smarty version Smarty-3.1.7, created on 2018-08-14 20:19:46
         compiled from "/var/www/html/BMLGDEMO65/includes/runtime/../../layouts/vlayout/modules/ProjectTask/DetailViewBlockView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18869396835b733962dd3e58-44481576%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '700495e9bef8464619be38695c16f294c849aa6c' => 
    array (
      0 => '/var/www/html/BMLGDEMO65/includes/runtime/../../layouts/vlayout/modules/ProjectTask/DetailViewBlockView.tpl',
      1 => 1499798856,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18869396835b733962dd3e58-44481576',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b733962f04da',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b733962f04da')) {function content_5b733962f04da($_smarty_tpl) {?>
...
"></td><td class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"></td><?php }?></tr><?php if ($_smarty_tpl->tpl_vars['BLOCK_LABEL_KEY']->value=='Users'){?><tr><?php $_smarty_tpl->tpl_vars["USERS_LIST_INFO"] = new Smarty_variable($_smarty_tpl->tpl_vars['USER_MODEL']->value->getAccessibleUsersForModule($_smarty_tpl->tpl_vars['MODULE_NAME']->value), null, 0);?><?php $_smarty_tpl->tpl_vars["GROUPS_LIST_INFO"] = new Smarty_variable($_smarty_tpl->tpl_vars['USER_MODEL']->value->getAccessibleGroupForModule($_smarty_tpl->tpl_vars['MODULE_NAME']->value), null, 0);?><td colspan='4'><table class="table table-bordered equalSplit detailview-table"><thead><tr><th>User</th><th>Start Date</th><th>End Date</th><th>Allocated Hours</th><th>Worked Hours</th><th>Status</th></tr></thead><tbody id="Userinfoblock"><?php  $_smarty_tpl->tpl_vars['pt_taskdata'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['pt_taskdata']->_loop = false;
 $_smarty_tpl->tpl_vars['info'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['PT_USER_INFO']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?><?php $_smarty_tpl->tpl_vars['row_no'] = new Smarty_variable($_smarty_tpl->tpl_vars['pt_taskdata']->value['userid'], null, 0);?><tr><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("Project_User_Task_Detail.tpl",'ProjectTask'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('row_no'=>$_smarty_tpl->tpl_vars['row_no']->value,'data'=>$_smarty_tpl->tpl_vars['pt_taskdata']->value), 0);?>
</tr><?php } ?></tbody></table></td></tr><?php }?></tbody></table><br><?php } ?><?php }} ?>