...
{strip}
    ...
    <div class="vte-login-container">
        <div class="logo">
            <img src="test/logo/BMLGsmalltransv1.jpg" />
        </div>
        <div class="row-fluid">
                    ...
                    <ul class="bxslider">
                        <li>
                                <div id="slide0" class="slide">
                                    <img class="pull-left" src="test/logo/slide_1-370x210.jpg">
                                </div>
                            </li><li>
                                <div id="slide1" class="slide">
                                    <img class="pull-left" src="test/logo/img_10-370x210.jpg">
                                </div>
                            </li><li>
                                <div id="slide2" class="slide">
                                    <img class="pull-left" src="test/logo/img_21-370x210.jpg">
                                </div>
                            </li>
                    </ul>
                </div>
            ...
            <div class="span6 login-area">
                ...
                <div class="span12 site-info">
                    <h1 class="login-header">Benchmark Labs ERP SYSTEM</h1>
                    <p>Benchmark Labs ERP SYSTEM is the first secure Web based seed-to-sale software that is both ISO 17025(2005) and Safe Quality Food (SQF) complaint.</p>
                </div>
                ...
                <div class="span12 login-more-info vte-user-login">
                    <div class="row">
                        ...
                        <div class="span6 copy-right">
                            <small>Benchmark Labs 2016</small>
                        </div>
                    </div>
                </div>
