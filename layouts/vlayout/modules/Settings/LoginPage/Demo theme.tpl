...
<html>
   ...
   <body>
      <div class="vte-login-container"><div class="logo"><img src="loginimages/logo-rnbw-cloud2-300x258_1533119002.png" /></div><div class="row-fluid"><div class="span6 slideshow">
						<div class="carousal-container">
							<ul class="bxslider"><li> <div id="slide0" class="slide"><img class="pull-left" src="loginimages/download_1533119002.jpg"></div></li><li> <div id="slide1" class="slide"><img class="pull-left" src="loginimages/c990f33ce5ac26f122c489da6de8c904_1533119002.jpg"></div></li><li> <div id="slide2" class="slide"><img class="pull-left" src="loginimages/marijuana-harvesting_1533119002.jpg"></div></li><li> <div id="slide3" class="slide"><img class="pull-left" src="loginimages/1508257372649_1533119002.jpg"></div></li></ul>
				</div>
			</div><style> .login-header, .subtitle { color:#000080; } .signin-button .btn { border-color:#000080; background-color:#000080; } .login-more-info .copy-right small{  color: #000080 } h3.forgot-password {  color: #000080  !important;  }</style>
				<div class="span6 login-area">
				<div class="span12 site-info">
				<h1 class="login-header">Login area</h1>
				<p class="subtitle"></p>
				</div>
