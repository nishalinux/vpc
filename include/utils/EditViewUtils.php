...
function getAssociatedProducts($module,$focus,$seid='')
{
	...
	if($module == 'Quotes' || $module == 'PurchaseOrder' || $module == 'SalesOrder' || $module == 'Invoice' || $module == 'PickingSlip' || $module == 'ProjectStock')
	{
		$query="SELECT
	...
	for($i=1;$i<=$num_rows;$i++)
	{
		...
		if($module == 'PurchaseOrder' || $module == 'SalesOrder' || $module == 'Quotes' || $module == 'Invoice' || $module == 'PickingSlip' || $module == 'ProjectStock')
		{
