...
<html>
   ...
   <body>
      <div class="vte-login-container"><div class="logo"><img src="loginimages/TheraCann_SYSTEM Logo_1517844048_1533188810.png" /></div><div class="row-fluid"><div class="span6 slideshow">
						<div class="carousal-container">
							<ul class="bxslider"><li> <div id="slide0" class="slide"><img class="pull-left" src="loginimages/parrots_1533188810.jpg"></div></li><li> <div id="slide1" class="slide"><img class="pull-left" src="loginimages/SUPPORT_1517839005_1533188810.jpg"></div></li></ul>
				</div>
			</div><style> .login-header, .subtitle { color:#4439c4; } .signin-button .btn { border-color:#4439c4; background-color:#4439c4; } .login-more-info .copy-right small{  color: #4439c4 } h3.forgot-password {  color: #4439c4  !important;  }</style>
				<div class="span6 login-area">
				<div class="span12 site-info">
				<h1 class="login-header">Login page</h1>
				<p class="subtitle">Theracann</p>
				</div>
				...
				<div class="row"><div class="span6 " ><small>login page testing in demo</small></div><div class="span4 social" >
