...
public function transferListSearchParamsToFilterCondition($listSearchParams, $moduleModel) {
		...
		$column = array();
		if($srcmodule == 'PickingSlip' || $srcmodule == 'ProjectStock' ){
			$column[0]['columnname'] ='vtiger_project:projectstatus:projectstatus:Project_Status:V';
			$column[0]['comparator'] = 'n' ;
			$column[0]['value'] ='completed';
	...
	public function initializeListViewContents(Vtiger_Request $request, Vtiger_Viewer $viewer) {
		...
		//Manasa Added :: Expect Completed projects in popup
		$searchParmams = array();
