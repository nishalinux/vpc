...
{strip}
    <div class='container-fluid editViewContainer'>
        <form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="index.php" enctype="multipart/form-data">
			...
			{if $BLOCK_LABEL eq 'Section 5.a.i. Quantity to be Produced'}
				{include file="LineItemsEdit.tpl"|@vtemplate_path:'ACMPR'}
			{/if}
			{if $BLOCK_LABEL eq 'Section 4 Security Clearance'}
				{include file="ARPICEdit.tpl"|@vtemplate_path:'ACMPR'}
				<br/>
			{/if}
			{if $BLOCK_LABEL eq 'Section 4 Security Clearance'}
				{include file="PersonEdit.tpl"|@vtemplate_path:'ACMPR'}
			{/if}
