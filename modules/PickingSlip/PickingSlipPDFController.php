...
include_once dirname(__FILE__). '/PickingSlipPDFHeaderViewer.php';

class Vtiger_PickingSlipPDFController extends Vtiger_InventoryPDFController{
	function buildHeaderModelTitle() {
		...
		return sprintf("%s: %s", $translatedSingularModuleLabel, $this->focusColumnValue('pickingslip_no'));
	}

	function getHeaderViewer() {
		$headerViewer = new PickingSlipPDFHeaderViewer();
