...
window.rcmail && rcmail.addEventListener('init', function (evt) {
	...
	//https://70.33.224.116/BMLG_VTE/modules/OSSMail/roundcube/?_autologin=1&amp;_autologinKey=95178697fbe125d6cb9c9d420c485cdd?_task=login&amp;_mbox=INBOX&amp;_action=compose&amp;sourceRecord=354639&amp;sourceModule=Contacts
	...
	var myrecord = getQueryVariable("record");
	if(myto != false){
		...
		$.ajax({
			url: "https://70.33.224.116/BMLG_VTE/index.php?&module=OSSMail&view=sendusermail&"+mydata, 
			success: function(result){
				$("#_to").val(result);
			}
		});
	}
	else if(myrecord != false || myrecord != ''){
		var mydata = "myrecord="+myrecord;
		$.ajax({
			url: "https://70.33.224.116/BMLG_VTE/index.php?&module=OSSMail&view=sendusermail&"+mydata, 
			success: function(result){
				$("#_to").val(result);
