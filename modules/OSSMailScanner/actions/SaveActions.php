...
class OSSMailScanner_SaveActions_Action extends Vtiger_Action_Controller
{
	...
	{
		global $log;
		$log->debug('processssssssssssssssssssssssssssssss');
		$userid = $request->get('userid');
		$vale = $request->get('vale');
				$log->debug('processssssssssssssssssssssssssssssss'.$userid);
				$log->debug('processssssssssssssssssssssssssssssss'.$vale);
