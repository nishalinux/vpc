<?php
class PickingSlip_ProductsPopup_View extends Inventory_ProductsPopup_View {
function getModule($request) {
	...
	public function transferListSearchParamsToFilterCondition($listSearchParams, $moduleModel) {
		...
		$column = array();
		if($count == 0){
			$column[1]['columnname'] ='vtiger_products:product_no:product_no:Products_Product_Number:V';
			$column[1]['comparator'] = $v[1] ;
			$column[1]['value'] =$v[2] ;
		}
