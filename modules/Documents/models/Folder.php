...
class Documents_Folder_Model extends Vtiger_Base_Model {
	...
	public function save() {
		...
		$params = array($folderId,$folderName, $folderDesc, $currentUserId, $sequence,$parentid);

		$db->pquery("INSERT INTO vtiger_attachmentsfolder(folderid,foldername, description, createdby, sequence,parentid) VALUES(?, ?, ?, ?, ?,?)", $params);
