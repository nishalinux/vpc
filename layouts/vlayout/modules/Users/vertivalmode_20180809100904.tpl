   ...
   <head>
	  ...
	  <script src="libraries/jquery/boxslider/respond.min.js"></script>
	   ...
	   <script>
		jQuery(document).ready(function () {
			  ...
			  slider = jQuery('.bxslider').bxSlider({
		...
		</script></head><body><div class="vte-login-container"><div class="logo"><img src="loginimages/TheraCann_SYSTEM Logo_1517844048_1533809345.png" /></div><div class="row-fluid"><div class="span6 slideshow" style="margin-left:0;">
						<div class="carousal-container">
							<ul class="bxslider"><li> <div id="slide0" class="slide"><img class="pull-left" src="loginimages/267f709e4c8b696957ebf9f187c0d344--iphone-backgrounds-phone-wallpapers_1533809345.jpg"></div></li><li> <div id="slide1" class="slide"><img class="pull-left" src="loginimages/648773_1533809345.jpg"></div></li><li> <div id="slide2" class="slide"><img class="pull-left" src="loginimages/IMG_478921_1533809345.jpg"></div></li></ul>
				</div>
			</div><style> .login-header, .subtitle { color:#789766; } .signin-button .btn { border-color:#789766; background-color:#789766; } .login-more-info .copy-right small{  color: #789766 } h3.forgot-password {  color: #789766  !important;  }</style>
				<div class="span6 login-area">
				<div class="span12 site-info">
				<h1 class="login-header">vertical_mode_test</h1>
				<p class="subtitle">vertical</p>
				</div>
				...
				<div class="row"><div class="span6 " ><small>vertical mode testing</small></div><div class="span4 social" >
