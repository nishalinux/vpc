...
<aside class="right-side">
	...
	<?PHP
		...
		if($ticketid != ''){
			$params = array('id' => "$ticketid", 'block'=>"$block",'contactid'=>$customerid,'sessionid'=>"$sessionid",'portaltype'=>$portaltype);
				...
				for($i=0;$i<$field_count;$i++,$z++){
					...
					if($data =='')
						...
						echo '<div class="form-group col-sm-6">
										...
										'</label>
										<div class="col-sm-9 dvtCellInfo maindiv" contenteditable="false" align="left" valign="top">
											&nbsp;
											<span id="summaryViewEdit" >'.$data.'</span>

											<span class="summaryViewEdit pull-right quickedit">&nbsp;<i class="glyphicon glyphicon-pencil" title="Edit"></i>
											</span>
										</div>
								</div>'; 
...
if (form_ele.value == '') return true;
	...
	return true;
 	...
 	$(".quickedit").click(function(){
        $(".maindiv").attr("contenteditable", "true");
    });
    ...
    $(document).mouseup(function(e) 
	{
	    ...
	    {
	        $(".maindiv").attr("contenteditable", "false");
	    }
	});
