...
jQuery.Class("Vtiger_Header_Js", {
    ...
    quickCreateGoToFullForm: function(form, editViewUrl) {
        ...
        //Manasa :: 08th dec 2017 "_self" additionally
        window.open(completeUrl,"_self");//added by murali for quick create add todo action*/
    },
...
//        }
	...
	/*Ganesh adding for page url load time*/
        var detailurl = '';
		console.log("YOGITA");
		...
		//var geturldata = JSON.parse('{"' + decodeURI(relatedurl).replace(/"/g, '\\"').replace(/&/g, '","').replace(/=/g,'":"') + '"}');
				   ...
				   var params = {};
					...
					AppConnector.request(params).then(
						...
						function(error) {
							...
							console.log("Very serious error. Investigate function registerEvents in Header.js");
						}	
					);
				});
			}
