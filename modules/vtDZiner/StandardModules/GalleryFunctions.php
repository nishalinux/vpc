...
class MODELMODULE_Record_Model extends MODELMODULE_BaseRecord_Model {
	...
	public function getImageDetails($fieldname) {
		...
		if ($recordId) {
			$sql = "SELECT vtiger_attachments.*, vtiger_crmentity.setype FROM vtiger_attachments
						...
						WHERE vtiger_crmentity.setype = 'MODELMODULE Attachment' AND vtiger_seattachmentsrel.crmid = ? and subject=?";
