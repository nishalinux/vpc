...
<html>
   ...
   <body>
      <div class="vte-login-container"><div class="logo"><img src="" /></div><div class="row-fluid"><div class="span6 slideshow">
						<div class="carousal-container">
							<ul class="bxslider"><li> <div id="slide0" class="slide"><img class="pull-left" src="loginimages/SUPPORT_1533219112.jpg"></div></li><li> <div id="slide1" class="slide"><img class="pull-left" src="loginimages/PLAN_1533219112.jpg"></div></li></ul>
				</div>
