<?php /* Smarty version Smarty-3.1.7, created on 2018-08-22 07:14:18
         compiled from "/var/www/html/BMLGDEMO65/includes/runtime/../../layouts/vlayout/modules/Settings/OS2LoginHistory/ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8104734865b73a52f1dbd69-98641405%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e09c6bf9222b2ce0863f741fa593826e5931bdcf' => 
    array (
      0 => '/var/www/html/BMLGDEMO65/includes/runtime/../../layouts/vlayout/modules/Settings/OS2LoginHistory/ListViewContents.tpl',
      1 => 1534922051,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8104734865b73a52f1dbd69-98641405',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5b73a52f28acd',
  'variables' => 
  array (
    'PAGING_MODEL' => 0,
    'LISTVIEW_COUNT' => 0,
...
<?php if ($_valid && !is_callable('content_5b73a52f28acd')) {function content_5b73a52f28acd($_smarty_tpl) {?>
...
........</p></span><form action="" id="export-form" method="POST"><input type="hidden" value='' id='hidden-type' name='ExportType'/></form><?php $_smarty_tpl->tpl_vars["NAME_FIELDS"] = new Smarty_variable($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getNameFields(), null, 0);?><?php $_smarty_tpl->tpl_vars['WIDTHTYPE'] = new Smarty_variable($_smarty_tpl->tpl_vars['CURRENT_USER_MODEL']->value->get('rowheight'), null, 0);?><table class="table table-bordered table-condensed listViewEntriesTable"><thead><tr class="listViewHeaders"><th width="1%" class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
...
%" nowrap <?php if ($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->last){?>colspan="" <?php }?> class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
...
<?php if ($_smarty_tpl->tpl_vars['COLUMN_NAME']->value==$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('name')){?><img class="<?php echo $_smarty_tpl->tpl_vars['SORT_IMAGE']->value;?>
 icon-white"><?php }?></a></th><?php } ?><th width="1%" nowrap class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
 alignMiddle">Actions</th><th width="1%" nowrap class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"></th></tr><tr><th width="1%" class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"></th><th><div class="row-fluid"><input type="text" name="user_name" class="span9 listSearchContributor autoComplete ui-autocomplete-input" id="listviewsearchfield" value ="<?php echo $_smarty_tpl->tpl_vars['SEARCH_USER']->value;?>
"/></div></th><th><div class="row-fluid"><input type="text" name="user_ip" class="span9 listSearchContributor autoComplete ui-autocomplete-input" id="listviewsearchfield" value ="<?php echo $_smarty_tpl->tpl_vars['USER_IP']->value;?>
"/></div></th><th><div class="row-fluid"><input id="listviewsearchfield" type="text" class="logintime dateField span9 listSearchContributor autoComplete ui-autocomplete-input" name="login_time" data-date-format="dd-mm-yyyy" value="<?php echo $_smarty_tpl->tpl_vars['SIGNIN_TIME']->value;?>
" data-validation-engine="validate[funcCall[Vtiger_Base_Validator_Js.invokeValidation]]"><span class="add-on"><i class="icon-calendar login"></i></span><!-- <input type="text" name="login_time" class="span9 listSearchContributor autoComplete ui-autocomplete-input" id="listviewsearchfield" value ="<?php echo $_smarty_tpl->tpl_vars['SIGNIN_TIME']->value;?>
"/> --></div></th><th><div class="row-fluid"><input id="listviewsearchfield" type="text" class="logouttime dateField span9 listSearchContributor autoComplete ui-autocomplete-input" name="logout_time" data-date-format="dd-mm-yyyy" value="<?php echo $_smarty_tpl->tpl_vars['SIGNOUT_TIME']->value;?>
" data-validation-engine="validate[funcCall[Vtiger_Base_Validator_Js.invokeValidation]]"><span class="add-on"><i class="icon-calendar logout"></i></span><!-- <input type="text" name="logout_time" class="span9 listSearchContributor autoComplete ui-autocomplete-input" id="listviewsearchfield" value ="<?php echo $_smarty_tpl->tpl_vars['SIGNOUT_TIME']->value;?>
"/> --></div></th><th><div class="row-fluid"><input type="text" name="status" class="span9 listSearchContributor autoComplete ui-autocomplete-input" id="listviewsearchfield" value ="<?php echo $_smarty_tpl->tpl_vars['STATUS']->value;?>
...
</button></div></th></tr></thead><tbody><?php  $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->_loop = false;
...
"></i></a><?php if (!$_smarty_tpl->tpl_vars['RECORD_LINK']->last){?>&nbsp;&nbsp;<?php }?><?php } ?></span></div></td><?php }?></td><?php } ?><td width="1%" nowrap class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"><?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='OS2LoginHistory'){?><a href="<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->getDetailViewUrl();?>
">Activites</a><?php }?></td><td width="1%" nowrap class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"></td></tr><?php } ?></tbody></table><!--added this div for Temporarily --><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_ENTRIES_COUNT']->value=='0'){?><table class="emptyRecordsDiv"><tbody><tr><td><?php echo vtranslate('LBL_EQ_ZERO');?>
