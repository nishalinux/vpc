...
class Users_Module_Model extends Vtiger_Module_Model {
   ...
   /**
	...
	public function saveLoginHistory($username){
		...
		//$loginTime = Vtiger_Datetime_UIType::getDBDateTimeValue($intime);
	...
	public function saveLogoutHistory(){
		...
		//$logout_time = Vtiger_Datetime_UIType::getDateTimeValue($outtime);
		...
		if (!empty($loginid)){
			...
			$result = $adb->pquery($query, array($logout_time, 'Signed off', $loginid));
		}
	}
