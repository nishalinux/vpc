   ...
   <head>
	  ...
	  <script src="libraries/jquery/boxslider/respond.min.js"></script>
	   ...
	   <script>
		jQuery(document).ready(function () {
			  ...
			  slider = jQuery('.bxslider').bxSlider({
		...
		</script></head><body><div class="vte-login-container"><div class="logo"><img src="" /></div><div class="row-fluid"><div class="span6 slideshow" style="margin-left:0;">
						<div class="carousal-container">
							<ul class="bxslider"><li> <div id="slide0" class="slide"><img class="pull-left" src="loginimages/Apollo_Nachtansicht_3_MB_1533725936.jpg"></div></li><li> <div id="slide1" class="slide"><img class="pull-left" src="loginimages/GettyImages-634869043-58a6e83f5f9b58a3c918ca12_1533725936.jpg"></div></li></ul>
				</div>
				...
				<div class="row"><div class="span6 " ><small>Testing in chrome browser</small></div><div class="span4 social" >
