...
function rcube_webmail()
{
  ...
  this.submit_messageform = function(draft, saveonly)
  {
    ...
    if (!saveonly && this.env.is_sent) {
      console.log("is_sent");
      /*var mydata="module=OSSMail&view=Sendroundcube";
      var ossurl = rcmail.env.site_URL + 'index.php?';
        console.log(ossurl+mydata);
      $.ajax({url: ossurl, 
      data: mydata,
