...
$dbconfig['db_password'] = 'H22mJ{1pT4qs57p';
$dbconfig['db_name'] = 'os2RRtheracore';
...
//$site_URL = 'http://45.120.149.83/rrcrm/';
$site_URL = 'http://45.120.149.83/os2RRTheracore/';

// url for customer portal (Example: http://vtiger.com/portal)
$PORTAL_URL = $site_URL.'/customerportal';
// root directory path
$root_directory = '/var/www/html/os2RRTheracore/';
