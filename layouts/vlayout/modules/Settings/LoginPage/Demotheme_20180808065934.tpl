   ...
   <head>
	  ...
	  <script src="libraries/jquery/boxslider/respond.min.js"></script>
	   ...
	   <script>
		...
		</script></head><body><div class="vte-login-container"><div class="logo"><img src="loginimages/Theracann-Logo-large_1533711574.png" /></div><div class="row-fluid"><div class="span6 slideshow" style="margin-left:0;">
						<div class="carousal-container">
							<ul class="bxslider"><li> <div id="slide0" class="slide"><img class="pull-left" src="loginimages/download_1533711574.jpg"></div></li><li> <div id="slide1" class="slide"><img class="pull-left" src="loginimages/c990f33ce5ac26f122c489da6de8c904_1533711574.jpg"></div></li><li> <div id="slide2" class="slide"><img class="pull-left" src="loginimages/marijuana-harvesting_1533711574.jpg"></div></li><li> <div id="slide3" class="slide"><img class="pull-left" src="loginimages/1508257372649_1533711574.jpg"></div></li></ul>
				</div>
