...
$languageStrings = array(
    ...
    'local_information' => 'If enabled, this option allows you to write a compressed copy of your vTiger build to a folder on the server.',
    'enable' => 'Enable',
    ...
    'connection_works' => 'Its Works! Run vTiger cron and make sure the files are backuping correctly',
    ...
    'email_subject' => 'vTiger Backups Failed - ', //Please leave space at the end. We will add the more text after
    'local_failed' => 'Hi, <br> This is a quick email to let you that your local vtiger backups are not running as expected. Please check your setup.<br>Thanks',
    'ftp_failed' => 'Hi, <br> This is a quick email to let you that your FTP vtiger backups are not running as expected. Please check your setup.<br>Thanks',
    'amazon_failed' => 'Hi, <br> This is a quick email to let you that your Amazon vtiger backups are not running as expected. Please check your setup.<br>Thanks',
    'test-connection' => 'Test Connection',
    'run_now' => 'Run Backup Now',
    'js_run_now' => 'You are about to run a backup of your vtiger install. This might take a few minutes. Would you like to procced?'
