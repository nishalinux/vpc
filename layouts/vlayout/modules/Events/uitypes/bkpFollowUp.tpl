...
<td class="fieldLabel">
	...
	</label><input type="text" name="sreecounter" value="{$COUNTER}">
	<input type="hidden" text="sreefolooe" value="{$SHOW_FOLLOW_UP}">
	<input type="hidden" text="sreefolooe" value="{$FOLLOW_UP_STATUS}">	
</td>
