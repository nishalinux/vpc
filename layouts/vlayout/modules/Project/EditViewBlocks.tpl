...
{strip}
    <div class='container-fluid editViewContainer'>
        <form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="index.php" enctype="multipart/form-data">
            ...
            {/if}
			{*Manasa added on :: 6 dec 2017 to read duplicate status and id*}
			<input type="hidden" name="duplicatestatus" value="{$smarty.request.isDuplicate}" />
            <input type="hidden" name="oldrecord" value="{$smarty.request.record}" />
			{*ended here*}
