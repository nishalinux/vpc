...
<div class="panel-group" id="accordion">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h3 class="panel-title">
			<a data-toggle="collapse" data-parent="#accordion" href="#collapse4"><i class="icon-chevron-down alignMiddle"></i>&nbsp;CRM Info</a>
			</h3><br>
		</div>
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h3 class="panel-title">
			<a data-toggle="collapse" data-parent="#accordion" href="#collapse5"><i class="icon-chevron-down alignMiddle"></i>&nbsp;vtDZiner</a>
			</h3><br>
		</div>
		<div id="collapse5" class="panel-collapse collapse">
			<table class="table equalSplit">
				<tr><td>VTDZINED</td><td>{$VTDZINSTALLED}</td><td></td></tr>
