<?php /* Smarty version Smarty-3.1.7, created on 2018-08-14 20:16:30
         compiled from "/var/www/html/BMLGDEMO65/includes/runtime/../../layouts/vlayout/modules/ProcessFlow/DetailViewHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16932792205b73389e19fef4-51137991%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c1fa5066e1886ced07e33e2a93b08ef81bd5002e' => 
    array (
      0 => '/var/www/html/BMLGDEMO65/includes/runtime/../../layouts/vlayout/modules/ProcessFlow/DetailViewHeader.tpl',
      1 => 1532585234,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16932792205b73389e19fef4-51137991',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b73389e20867',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b73389e20867')) {function content_5b73389e20867($_smarty_tpl) {?>
...
<?php }?>><strong><?php if ($_smarty_tpl->tpl_vars['DETAIL_VIEW_BASIC_LINK']->value->getLabel()=='LBL_EDIT'){?>Run<?php }else{ ?><?php echo vtranslate($_smarty_tpl->tpl_vars['DETAIL_VIEW_BASIC_LINK']->value->getLabel(),$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
<?php }?></strong></button></span><?php } ?><?php if (count($_smarty_tpl->tpl_vars['DETAILVIEW_LINKS']->value['DETAILVIEWSETTING'])>0){?><span class="btn-group"><button class="btn dropdown-toggle" href="#" data-toggle="dropdown"><i class="icon-wrench" alt="<?php echo vtranslate('LBL_SETTINGS',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
