...
Users_Edit_Js("Users_PreferenceEdit_Js",{
	...
	registerChangeEventForCurrencySeperator : function(){
		...
		jQuery('[name="currency_grouping_separator"]',form).on('change',function(e){
			...
			registerSignForCkEditor : function(){
		var form = jQuery('form');
		var noteContentElement = form.find('[name="signature"]');
		if(noteContentElement.length ==1){
	...
	registerEvents : function(){
		this._super();
	//	this.registerSignForCkEditor(); // need to register in this function.
