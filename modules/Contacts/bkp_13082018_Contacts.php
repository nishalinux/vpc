	...
	function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
		...
		$query = "select case when (vtiger_users.user_name not like '') then $userNameSql else vtiger_groups.groupname end as user_name," .
				...
				" and vtiger_crmentity.crmid = vtiger_activity.activityid  and vtiger_contactdetails.contactid = ".$id." and" .
						" vtiger_activity.activitytype='Emails' and vtiger_crmentity.deleted = 0 order by date_start desc ,time_start desc ";
...
function get_attachments_bkp($id, $cur_tab_id, $rel_tab_id, $actions = false) {//commented on may 15th 2016
	 ...
	 $query = "select case when (vtiger_users.user_name not like '') then $userNameSql else vtiger_groups.groupname end as user_name," .
				"'Documents' ActivityType,vtiger_attachments.type  FileType,vtiger_crmentity.modifiedtime lastmodified,vtiger_crmentity.modifiedtime,
				...
				where vtiger_notes.related_to=" . $id;
