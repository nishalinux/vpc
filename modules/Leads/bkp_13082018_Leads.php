...
class Leads extends CRMEntity {
	...
	*/
	...
	{
		$this->insertIntoAttachment($this->id,$module); //Added by Abilash 19 Aug 16 for attachment
	}
	//Added by Abilash for attachment 19 Aug 2016
...
//Added by Abilash for attachment 19 Aug 2016 ---end
	...
	*/
	...
	function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
		...
		$query ="select case when (vtiger_users.user_name not like '') then $userNameSql else vtiger_groups.groupname end as user_name," .
				...
				" left join vtiger_groups on vtiger_groups.groupid=vtiger_crmentity.smownerid" .
				" left join vtiger_users on  vtiger_users.id=vtiger_crmentity.smownerid" .
				" where vtiger_activity.activitytype='Emails' and vtiger_crmentity.deleted=0 and vtiger_seactivityrel.crmid=".$id." order by date_start desc ,time_start desc ";
