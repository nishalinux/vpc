                    ...
                    <ul class="bxslider">
                        <li>
                                <div id="slide0" class="slide">
                                    <img class="pull-left" src="test/logo/PLAN.jpg">
                                </div>
                            </li><li>
                                <div id="slide1" class="slide">
                                    <img class="pull-left" src="test/logo/DESIGN.jpg">
                                </div>
                            </li><li>
                                <div id="slide2" class="slide">
                                    <img class="pull-left" src="test/logo/IMPLEMENT.jpg">
                                </div>
                            </li><li>
                                <div id="slide3" class="slide">
                                    <img class="pull-left" src="test/logo/SUPPORT.jpg">
                                </div>
                            </li>
                    </ul>
                </div>
                ...
                <div class="span12 login-more-info vte-user-login">
                    <div class="row">
                        <div class="span4 social">
                            <a class="social" target="_blank" href=" @theracanncorp">
                                            <i class="icon-social-twitter icons"></i>
                                        </a><a class="social" target="_blank" href=" https://www.linkedin.com/company-beta/10331273/">
