...
* ****************************************************************************** */*}
{strip}
    <div class="installationContents" style="border:1px solid #ccc;padding:2% 3%;">
        <form name="activateLicenseForm" action="index.php" method="post" id="installation_step2" class="form-horizontal">
            ...
            <div class="row" style="margin: 5px 0 10px 0;">
                <span class="col-lg-2"><span class="redColor">*</span><strong>{vtranslate('LBL_LICENSE_KEY',$QUALIFIED_MODULE)}</strong></span>
