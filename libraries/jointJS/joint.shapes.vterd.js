...
joint.shapes.erd.ParentEntity = joint.shapes.erd.Entity.extend({

    defaults: joint.util.deepSupplement({

        type: 'erd.ParentEntity',
        attrs: {
            '.outer': {
                fill: '#EEE423', stroke: '#A39D2A', 'stroke-width': 2,
                points: '100,0 100,60 0,60 0,0'
            },
            '.inner' : {
                fill: '#2ECC71', stroke: '#27AE60', 'stroke-width': 2,
...
joint.shapes.erd.ChildEntity = joint.shapes.erd.Entity.extend({

    defaults: joint.util.deepSupplement({

        type: 'erd.ChildEntity',
        attrs: {
            '.outer': {
                fill: '#0FFADE', stroke: '#087C6F', 'stroke-width': 2,
                points: '100,0 100,60 0,60 0,0'
            },
            '.inner' : {
                fill: '#0FFADE', stroke: '#087C6F', 'stroke-width': 2,
