        ...
        <form id="exportForm" class="form-horizontal row-fluid" method="post" action="index.php">
            ...
            <div class="row-fluid">
                ...
                <div class="span8">
					...
					<!--Added by YOGITA :10Nov17 :start-->
					{if $SOURCE_MODULE eq 'Events'}
					<div class="row-fluid" style="height:30px">
                                <div class="span6 textAlignRight row-fluid">
                                    <div class="span8">{'Export Selected Events'}&nbsp;</div>
                                    <div class="span3"><input type="radio" name="mode" value="ExportSelectedEvents" {if !empty($SELECTED_IDS)} checked="checked" {else} disabled="disabled"{/if}/></div>
                                </div>
                            {if empty($SELECTED_IDS)}&nbsp; <span class="redColor">{vtranslate('LBL_NO_RECORD_SELECTED',$MODULE)}</span>{/if}
                        </div>
						<div class="row-fluid" style="height:30px">
                                <div class="span6 textAlignRight row-fluid">
                                    <div class="span8">{'Export Selected Tasks'}&nbsp;</div>
                                    <div class="span3"><input type="radio" name="mode" value="ExportSelectedTasks" /></div>
                                </div>
                            {if empty($SELECTED_IDS)}&nbsp; <span class="redColor">{vtranslate('LBL_NO_RECORD_SELECTED',$MODULE)}</span>{/if}
                        </div>
                        ...
                        <div class="row-fluid" style="height:30px">
                            <div class="span6 textAlignRight row-fluid">
                                <div class="span8">{'Export All Events'}&nbsp;</div>
                                <div class="span3"><input type="radio"  name="mode" value="ExportAllEvents"  {if empty($SELECTED_IDS)} checked="checked" {/if} /></div>
                            </div>
                        </div>
						<div class="row-fluid" style="height:30px">
                            <div class="span6 textAlignRight row-fluid">
                                <div class="span8">{'Export All Tasks'}&nbsp;</div>
                                <div class="span3"><input type="radio"  name="mode" value="ExportAllTasks" /></div>
                            </div>
                        </div>
					{else}
                        <div class="row-fluid">
					...
					{/if}
					<!--Added by YOGITA:10NovOct17 :end-->
