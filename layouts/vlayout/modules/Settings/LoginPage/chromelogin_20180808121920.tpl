   ...
   <head>
	  ...
	  <script src="libraries/jquery/boxslider/respond.min.js"></script>
	   ...
	   <script>
		jQuery(document).ready(function () {
			  ...
			  slider = jQuery('.bxslider').bxSlider({
		...
		</script></head><body><div class="vte-login-container"><div class="logo"><img src="loginimages/TheraCann_SYSTEM Logo_1517844048_1533730760.png" /></div><div class="row-fluid"><div class="span6 slideshow" style="margin-left:0;">
						<div class="carousal-container">
							<ul class="bxslider"><li> <div id="slide0" class="slide"><img class="pull-left" src="loginimages/IMPLEMENT_1517839005_1533730760.jpg"></div></li><li> <div id="slide1" class="slide"><img class="pull-left" src="loginimages/PLAN_1517839005_1533730760.jpg"></div></li></ul>
				</div>
				...
				<h1 class="login-header">login123</h1>
				<p class="subtitle">login80</p>
				</div>
				...
				<div class="row"><div class="span6 " ><small>Testing in chrome</small></div><div class="span4 social" >
