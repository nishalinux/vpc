...
<div class="row-fluid">
	...
	<div class='span5' style="overflow: hidden">
			<div class="summaryWidgetContainer">
				<div class="widgetContainer_processflow" >
					<div class="widget_header row-fluid">
						<span class="span9">
							<h4>Process Flows</h4>
						</span>
					</div>
					<div class="widget_contents_process">
						<div class="row-fluid">
							<span class="span6"><strong>Process Flow Name</strong></span>
							<span class="span3"><span class="pull-right"><strong>Start Date</strong></span></span>
							<span class="span3"><span class="pull-right"><strong>End Date</strong></span></span>
						</div>
						<div class="recentActivitiesContainer_processflow">
							{foreach item=process_data key=process_key from=$PROJECT_PROCESSFLOWS}
								<div class="row-fluid">
									<span class="span6 textOverflowEllipsis"><a href="index.php?module=ProcessFlow&view=Edit&record={$process_data['processflowid']}" id="" title="">{$process_data['processflowname']}</a></span>
									<span class="span3 horizontalLeftSpacingForSummaryWidgetContents">
										<span class="pull-right">
											{assign var="start_date" value=" "|explode:$process_data['process_flow_start_time']}
											{$start_date[0]}
										</span>
									</span>
									<span class="span3 horizontalLeftSpacingForSummaryWidgetContents">
										<span class="pull-right">
										{assign var="end_date" value=" "|explode:$process_data['process_flow_end_time']}
										{$end_date[0]}
										</span>
									</span>
								</div>
			...
			<div class="summaryWidgetContainer">
				<div class="widgetContainer_processflow" >
					<div class="widget_header row-fluid">
						<span class="span9">
							<h4>In Progress Processes</h4>
						</span>
					</div>
					<div class="widget_contents_process">
						<div class="row-fluid">
							<span class="span4"><strong>Process Flow</strong></span>
							<span class="span4 pull-left"><strong>Processes</strong></span>
							<span class="pull-right"><strong>Assigned</strong></span>
						</div>
						<div class="recentActivitiesContainer_processflow">
							{foreach item=process_data key=process_key from=$PROJECT_INPROGRESSPROCESSFLOWS}
								<div class="row-fluid">
									<span class="span4 "><a href="#" title="">{$process_data['processflowname']}</a></span>
									<span class="span4 textOverflowEllipsis">
										<span class="pull-left"><a href="#" title="">{$process_data['description']}</a></span>
									</span>
									<span class="span4 horizontalLeftSpacingForSummaryWidgetContents">
										<span class="pull-right"><a href="#" title="">{$process_data['assignedto']}</a></span>
									</span>
								</div>
							{/foreach}
						</div>
