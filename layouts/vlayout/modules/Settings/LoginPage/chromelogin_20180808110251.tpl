			  ...
			  slider = jQuery('.bxslider').bxSlider({
				  ...
				  onSliderLoad: function () {}
						...
						<div class="carousal-container">
							<ul class="bxslider"><li> <div id="slide0" class="slide"><img class="pull-left" src="loginimages/Baby_1533726172.jpg"></div></li><li> <div id="slide1" class="slide"><img class="pull-left" src="loginimages/download_1533726172.jpg"></div></li></ul>
				</div>
