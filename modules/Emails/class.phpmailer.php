...
class PHPMailer {
  ...
  */
  ...
  public function CreateHeader() {
   ...
   // if($this->ConfirmReadingTo != '') {
      $result .= $this->AddrAppend('Disposition-Notification-To', $this->ReplyTo);
      $result .= $this->AddrAppend('X-Confirm-Reading-To', $this->ReplyTo);
    //}
  ...
  */
   ...
   */
  public function MsgHTML($message, $basedir = '', $advanced = true) {
