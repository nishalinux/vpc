...
//Added by SL for attachments in listview of MailManager :start
	...
	public static function parseOverview($result) {
		...
		$instance->setAttNo($this->AttNo());//Added by SL for attachments in listview of MailManager
		$instance->setAttMuid($this->AttMuid());//Added by SL for attachments in listview of MailManager
