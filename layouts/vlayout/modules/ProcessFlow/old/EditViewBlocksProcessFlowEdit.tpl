        ...
        <form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="index.php" enctype="multipart/form-data">
            ...
            <div class="contentHeader row-fluid">
                ...
                <span class="pull-right"> 
					<button class="btn btn-success" type="submit">Save</strong></button>
					            
					{if $PROCESS_MASTER_DATA['termination_status'] == 'Normal' ||  $PROCESS_MASTER_DATA['termination_status'] == ''} 
					<button class='btn btn-danger btn-xs btnAbort' type="button" >Abort Batch Run</button>
					{/if} 
					{if $PROCESS_MASTER_DATA['total_not_started_tasks'] == '0' && ($PROCESS_MASTER_DATA['total_tasks'] == $PROCESS_MASTER_DATA['total_completed_tasks'] ) }       
					...
					<div class="accordion-group">
						...
						<div id="collapse_{$pid}" class="accordion-body collapse {if $ps == 1 || $ps == 3 || $ps == 4}in{/if}">
							<div class="accordion-inner">
								...
								<td width='50%'>
									<p class="clsPLrnMode">{if $pdata['learnermodedetails'] != ''} 
										<b>Help :</b> {$pdata['learnermodedetails']}
									{/if}</p>
