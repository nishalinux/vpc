...
Class SampleAnalysis_Edit_View extends Vtiger_Edit_View {
	...
	public function process(Vtiger_Request $request) {
		...
		$viewer->assign('KITLIST', $this->getKitList());
	...
	public function getKitList(){
		...
		$result = $adb->pquery("select * from vtiger_phylos_kit_list",array());
		$data = array();
		while($dataresult = $adb->fetch_array($result)){
			$data[$dataresult['id']] = $dataresult['kitid'];
		}
		return $data;
