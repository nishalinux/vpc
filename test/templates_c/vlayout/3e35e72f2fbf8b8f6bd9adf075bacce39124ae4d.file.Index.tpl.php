<?php /* Smarty version Smarty-3.1.7, created on 2018-08-16 14:56:10
         compiled from "/var/www/html/BMLGDEMO65/includes/runtime/../../layouts/vlayout/modules/Settings/CustomerPortal/Index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5607297275b75908ae5f952-19759195%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3e35e72f2fbf8b8f6bd9adf075bacce39124ae4d' => 
    array (
      0 => '/var/www/html/BMLGDEMO65/includes/runtime/../../layouts/vlayout/modules/Settings/CustomerPortal/Index.tpl',
      1 => 1532434709,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5607297275b75908ae5f952-19759195',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b75908af0960',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b75908af0960')) {function content_5b75908af0960($_smarty_tpl) {?>
...
</h3></div><hr><div class="contents row-fluid"><form id="customerPortalForm" class="form-horizontal" method="GET"><div class="row-fluid"><input type="hidden" name="portalModulesInfo" value="" /><!-- added by jyothi --><div class="control-group"><label class="muted control-label"><?php echo vtranslate('Portal Type',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</label><div class="controls"><span class="row-fluid"><select id="portaltype" name="portaltype" class="select2 span3"><option>Select an Option</option><?php  $_smarty_tpl->tpl_vars['PORTAL_VALUE'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['PORTAL_VALUE']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['PORTAL_VALUES']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['PORTAL_VALUE']->key => $_smarty_tpl->tpl_vars['PORTAL_VALUE']->value){
$_smarty_tpl->tpl_vars['PORTAL_VALUE']->_loop = true;
?><option><?php echo $_smarty_tpl->tpl_vars['PORTAL_VALUE']->value;?>
</option><?php } ?><!-- 	<option>Type1</option><option>Type2</option> --></select><span class="span1">&nbsp;</span><span class="span7"><i class="icon-info-sign alignMiddle"></i>&nbsp;<?php echo vtranslate('Type of User login into the Customer Portal',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span><span class="span1">&nbsp;</span></span></div></div><!-- ende here --><div class="control-group"><label class="muted control-label"><?php echo vtranslate('LBL_PRIVILEGES',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</label><div class="controls"><span class="row-fluid"><select name="privileges" class="select2 span3"><!-- <?php  $_smarty_tpl->tpl_vars['PROFILE_MODEL'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['PROFILE_MODEL']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['PROFILE_MODELS']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?><option><?php echo $_smarty_tpl->tpl_vars['PROFILE_MODEL']->value;?>
</option><?php } ?> --><?php  $_smarty_tpl->tpl_vars['USER_MODEL'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['USER_MODEL']->_loop = false;
...
</div><br><table id="portalModulesTable" class="table table-bordered table-condensed themeTableColor portal_table"><thead><tr class="blockHeader"><th><?php echo vtranslate('LBL_MODULE_NAME',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</th></tr></thead><tbody><!-- <?php echo print_r($_smarty_tpl->tpl_vars['MODULES_MODELS']->value);?>
 --><?php if ($_smarty_tpl->tpl_vars['MODULES_MODELS']->value==''){?><tr><td><strong>Select portaltype to enable modules</strong></td></tr><?php }else{ ?><?php  $_smarty_tpl->tpl_vars['MODEL'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['MODEL']->_loop = false;
...
</label></td></tr><?php } ?><?php }?></tbody></table></div><div class="row-fluid"><div class="span6 padding1per"><button class="btn btn-success pull-right" type="submit" disabled="true" name="savePortalInfo"><strong><?php echo vtranslate('LBL_SAVE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
