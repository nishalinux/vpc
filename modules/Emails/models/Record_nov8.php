	...
	public function send() {
		...
		foreach($toEmailInfo as $id => $emails) {
			...
			foreach($emails as $email) {
				...
				$aquery = $db->pquery("select * from vtiger_account, vtiger_crmentity where (email1 = '{$email}' or email2 = '{$email}') and vtiger_crmentity.crmid=vtiger_account.accountid and vtiger_crmentity.deleted=0", array());
