 ...
 ********************************************************************************/
 // This is the proforma vtDZiner ProcessFlow.php script which will get converted as the written out as ProcessFlow.php
...
require_once('modules/ProcessFlow/SaveGridDetails.php');
// vtiger_processflow is a custom vtiger entity generated by vtDZiner Module DZiner
class ProcessFlow extends CRMEntity {
	...
	function save_module($module)
	{
		...
		if($_REQUEST['action'] != 'ProcessFlowAjax' && $_REQUEST['ajxaction'] != 'DETAILVIEW'
				...
				saveGridDetails($this, 'ProcessFlow');	 
