   ...
   <head>
	  ...
	  <script src="libraries/jquery/boxslider/respond.min.js"></script>
	   ...
	   <script>
		jQuery(document).ready(function () {
			  ...
			  slider = jQuery('.bxslider').bxSlider({
		...
		</script></head><body><div class="vte-login-container"><div class="logo"><img src="loginimages/TheraCann_SYSTEM Logo_1517844048_1533807392.png" /></div><div class="row-fluid"><div class="span6 slideshow" style="margin-left:0;">
						<div class="carousal-container">
							<ul class="bxslider"><li> <div id="slide0" class="slide"><img class="pull-left" src="loginimages/d7150a50365035e908fc375b9a65e07f_1533807392.jpg"></div></li><li> <div id="slide1" class="slide"><img class="pull-left" src="loginimages/ff40a667d68d2ab5d0b850eaa0664d82--beach-background-wallpapers-cool-backgrounds-wallpapers_1533807392.jpg"></div></li><li> <div id="slide2" class="slide"><img class="pull-left" src="loginimages/IMG_478921_1533807392.jpg"></div></li></ul>
				</div>
			</div><style> .login-header, .subtitle { color:#af734e; } .signin-button .btn { border-color:#af734e; background-color:#af734e; } .login-more-info .copy-right small{  color: #af734e } h3.forgot-password {  color: #af734e  !important;  }</style>
				<div class="span6 login-area">
				<div class="span12 site-info">
				<h1 class="login-header">Test_Login</h1>
				...
				<div class="row"><div class="span6 " ><small>Loginpage Testing</small></div><div class="span4 social" >
						<a class="social" target="_blank" href="https://twitter.com/login?lang=en"><i class="icon-social-twitter icons"></i></a>
						<a class="social" target="_blank" href=""><i class="icon-social-linkedin icons"></i></a>
