...
/**
	 ...
	 *///addded by SL for Carousel fix:Dated 9th july 2015
	public function getGalleryDetails() {
		...
		if ($recordId) {
			$sql = "SELECT vtiger_attachments.*, vtiger_crmentity.setype FROM vtiger_attachments
						...
						WHERE vtiger_crmentity.setype = 'Documents Attachment' AND vtiger_seattachmentsrel.crmid = ? ORDER BY subject";
	...
	}//addded by SL for Carousel fix:Dated 9th july 2015--end
	...
	function getFileDetails() {
		$db = PearDatabase::getInstance();
		$fileDetails = array();
		//echo "SELECT * FROM vtiger_attachments INNER JOIN vtiger_seattachmentsrel ON vtiger_seattachmentsrel.attachmentsid = tiger_attachments.attachmentsid	WHERE crmid =".$this->get('id');
