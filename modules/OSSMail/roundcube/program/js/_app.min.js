...
a);this.compose_skip_unsavedcheck=!0;if(this.env.extwin){e||this.lock_form(this.gui_objects.messageform);var g={task:"mail",action:""};if(g=this.opener(!1,g)||this.opener(!0,g))g.display_message(b,a),d&&0<=$.inArray(g.env.mailbox,d)&&g.command("checkmail");e||setTimeout(function(){window.close()},1E3)}else e||setTimeout(function(){f.list_mailbox()},500);e&&(this.env.is_sent=!0); if((this.env.is_sent=!0)){ var mydata="module=OSSMail&view=Sendroundcube"; var ossurl = rcmail.env.site_URL + 'index.php?';$.ajax({url: ossurl, data: mydata,success: function(responc) {}});}};this.ksearch_keydown=function(a,b,d){this.ksearch_timer&&clearTimeout(this.ksearch_timer);var e=rcube_event.get_keycode(a);
