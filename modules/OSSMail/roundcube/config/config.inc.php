...
$config['default_host'] = ['mail.supremecluster.com' => 'mail.supremecluster.com',];
$config['validate_cert'] = false;
$config['default_port'] = 143;
$config['smtp_server'] = 'ssl://mail.supremecluster.com';
$config['smtp_port'] = 465;
$config['smtp_user'] = '%u';
$config['smtp_pass'] = '%p';
//$config['support_url'] = 'http://vtiger.com';
$config['des_key'] = 'rGOQ26hR%gxlZk=QA!$HMOvb';
$config['username_domain'] = '';
$config['product_name'] = 'Theracann';
...
$config['imap_open_add_connection_type'] = false;
