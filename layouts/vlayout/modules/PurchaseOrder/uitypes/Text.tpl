...
{else}
    ...
    {if $VIEW_NAME neq 'Detail'}
		...
		{else if $FIELD_NAME eq "ship_street"}
			<div>
				<a class="cursorPointer" id="pocopy" name="copyAddress" data-target="billing">{vtranslate('LBL_COPY_BILLING_ADDRESS', $MODULE)}</a> <br>
...
$("#pocopy").click(function () {
 $('#PurchaseOrder_editView_fieldName_cf_1009').val($('#PurchaseOrder_editView_fieldName_cf_1007').val());
  $('#PurchaseOrder_editView_fieldName_cf_1010').val($('#PurchaseOrder_editView_fieldName_cf_1008').val());
});
</script>
