	...
	<form class="form-horizontal" id="massSave" method="post" action="index.php">
		...
		<div class="modal-body tabbable">
			 ...
			 <div class="row-fluid">
					...
					<div class="span2">{vtranslate('LBL_STEP_PHNE',$MODULE)}<span class="redColor">*</span></div>
			    ...
			    <br />
			<div class="row-fluid">
					<div class="span2">{vtranslate('LBL_STEP_LABLE',$MODULE)}</div>
					<div class="span10">
		...
		<div class="row-fluid" style="margin-top:15px">
			<div class="span2">{vtranslate('message',$MODULE)}</div>
