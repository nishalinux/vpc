...
class MailManager_Connector_Connector {
 ...
 $txt = "user id date".$port;
 $myfile = file_put_contents('logs9oct.txt', $txt.PHP_EOL , FILE_APPEND | LOCK_EX);
	...
	public function markMailRead($msgno) {
		...
		//imap_setflag_full($this->mBox, $msgno, '\\Seen \\Flagged');
		$this->mModified = true;
	}
