<?php /* Smarty version Smarty-3.1.7, created on 2018-08-15 15:18:30
         compiled from "/var/www/html/BMLGDEMO65/includes/runtime/../../layouts/vlayout/modules/Users/EditView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7709671475b744446b02fb6-50777792%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '56edcea8a55c8f79d77f2431767aac80ac5b2b24' => 
    array (
      0 => '/var/www/html/BMLGDEMO65/includes/runtime/../../layouts/vlayout/modules/Users/EditView.tpl',
      1 => 1493386009,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7709671475b744446b02fb6-50777792',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b744446bcfd1',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b744446bcfd1')) {function content_5b744446bcfd1($_smarty_tpl) {?>
...
<?php }elseif(($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getName()=='autologout_time')&&($_smarty_tpl->tpl_vars['USER_MODEL']->value->get('is_admin')!='on')){?><?php }else{ ?><?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label'),$_smarty_tpl->tpl_vars['MODULE']->value);?>
<?php }?><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMandatory()==true){?> <span class="redColor">*</span> <?php }?></td><?php if (($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getName()=='autologout_time')&&($_smarty_tpl->tpl_vars['USER_MODEL']->value->get('is_admin')!='on')){?><?php }else{ ?><td class="fieldValue <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
...
</td><?php }?><?php } ?></tr><?php }?></table><br><?php } ?><table class="table table-bordered marginLeftZero"><tr class="listViewActionsDiv"><th colspan="4"><?php echo vtranslate('LBL_TAG_CLOUD_DISPLAY',$_smarty_tpl->tpl_vars['MODULE']->value);?>
