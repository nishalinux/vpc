   ...
   <head>
	  ...
	  <script src="libraries/jquery/boxslider/respond.min.js"></script>
	   ...
	   <script>
		jQuery(document).ready(function () {
			  ...
			  slider = jQuery('.bxslider').bxSlider({
		...
		</script></head><body><div class="vte-login-container"><div class="logo"><img src="loginimages/TheraCannSystem-cropped_1533711188.jpg" /></div><div class="row-fluid"><div class="span6 slideshow" style="margin-left:0;">
						<div class="carousal-container">
							<ul class="bxslider"><li> <div id="slide0" class="slide"><img class="pull-left" src="loginimages/download_1533711188.jpg"></div></li><li> <div id="slide1" class="slide"><img class="pull-left" src="loginimages/c990f33ce5ac26f122c489da6de8c904_1533711188.jpg"></div></li><li> <div id="slide2" class="slide"><img class="pull-left" src="loginimages/marijuana-harvesting_1533711188.jpg"></div></li><li> <div id="slide3" class="slide"><img class="pull-left" src="loginimages/1508257372649_1533711188.jpg"></div></li><li> <div id="slide4" class="slide"><img class="pull-left" src="loginimages/webmaster_1533711188.jpg"></div></li></ul>
				</div>
				...
				<h1 class="login-header">Theracann</h1>
				<p class="subtitle">OneStop OneSolution</p>
				</div>
				...
				<div class="row"><div class="span4 social" >
						<a class="social" target="_blank" href="info@vtigress.com"><i class="icon-social-twitter icons"></i></a>
						<a class="social" target="_blank" href="info@vtigress.com"><i class="icon-social-linkedin icons"></i></a>
						<a class="social" target="_blank" href="info@vtigress.com"><i class="icon-social-facebook icons"></i></a>
								</div><div class="span6 copy-right" ><small>Terms and Conditions</small></div></div>
				</div>
			</div></div>
      </div>
