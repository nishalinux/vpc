	...
	public function folderMails($folder, $start, $maxLimit) {
		...
		if ($folderCheck->Nmsgs) {
			...
			if($flagseen == 1){//Added by SL for attachments in listview of MailManager
				$attmnt = $this->attachmentName($this->mBox,$result->msgno);//Added by Abilash for attachment on 30 Nov 2016
				if($attmnt->_attachments != 0){//Added by Abilash for attachment on 30 Nov 2016
