...
class SumField_Uninstall_View extends Settings_Vtiger_Index_View {
    ...
    function process (Vtiger_Request $request) {
        ...
        echo '<div class="container-fluid">
                ...
                <hr>';
        // Uninstall module relatedrecordupdate_settings
        $module = Vtiger_Module::getInstance('SumField');
        ...
        $res_template = $this->delete_folder('layouts/vlayout/modules/SumField');
        echo "&nbsp;&nbsp;- Delete SumField template folder";
        if($res_template) echo " - DONE"; else echo " - <b>ERROR</b>";
        echo '<br>';

        $res_module = $this->delete_folder('modules/SumField');
        echo "&nbsp;&nbsp;- Delete SumField module folder";
    ...
    function removeData(){
        ...
        // drop tables
        $sql = "DROP TABLE `sumfield_settings`;";
        $result = $adb->pquery($sql,array());

        // sumfield task type
        $sql = 'DELETE FROM com_vtiger_workflow_tasktypes WHERE tasktypename=? AND sourcemodule=? AND classname=?';
        $result = $adb->pquery($sql,array('SumFieldTask','SumField','SumFieldTask'));

        $message.= "&nbsp;&nbsp;- Delete Sum Field tables";
